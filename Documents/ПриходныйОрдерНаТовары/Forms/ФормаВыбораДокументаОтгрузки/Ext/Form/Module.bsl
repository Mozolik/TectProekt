...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОтбиратьПоТовару Тогда
		Элементы.ФормаВыбрать.Заголовок = НСтр("ru='Добавить товары из документов отгрузки';uk='Додати товари з документів відвантаження'");
	...
	Иначе
		Если Не (Параметры.Свойство("Номенклатура",Номенклатура)
			...
			ТекстЗаголовка = НСтр("ru='Выберите документ отгрузки';uk='Виберіть документ відвантаження'");
		Иначе
			ТекстЗаголовка = НСтр("ru='Выберите документ отгрузки по %ПредставлениеТовара%';uk='Виберіть документ відвантаження %ПредставлениеТовара%'");
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<без задания на перевозку>';uk='<без завдання на перевезення>'"));

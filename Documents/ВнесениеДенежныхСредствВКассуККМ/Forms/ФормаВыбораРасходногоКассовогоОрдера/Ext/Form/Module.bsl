...
Процедура ПринятьВКассу(Команда)
	...
	Если Не ЗначениеЗаполнено(СуммаВнесения) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Не введена сумма внесения';uk='Не введена сума внесення'"),,,
			"СуммаВнесения");
		Возврат;
	КонецЕсли;
	...
	Если СуммаКПоступлению < СуммаВнесения Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Сумма внесения денежных средств превышает возможную сумму поступления.';uk='Сума внесення грошових коштів перевищує можливу суму надходження.'"),,,
			"СуммаВнесения");
		Возврат;
	КонецЕсли;

...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Если Операция = Перечисления.ОперацииНормативовРаспределения.БлокировкаНорматива Тогда
			ТекстОшибки = НСтр("ru='На указанную дату блокировки действия уже введен документ для этой товарной категории и реквизита.';uk='На зазначену дату блокування дії вже введений документ для цієї товарної категорії і реквізиту.'");
		Иначе
			ТекстОшибки = НСтр("ru='На указанную дату начала действия уже введен документ для этой товарной категории и реквизита.';uk='На зазначену дату початку дії вже введений документ для цієї товарної категорії і реквізиту.'");
		КонецЕсли;
	...
	ТекстОшибкиСуммыДолей = НСтр("ru='Необходимо указать хотя бы одну долю распределения.';uk='Необхідно вказати хоча б одну частку розподілу.'");
	...
	ТекстОшибкиДублей = НСтр("ru='Значение ""%Значение%"" уже присутствует в списке нормативов.';uk='Значення %Значение%"" вже присутнє у списку нормативів.'");
				...
				Пока Индекс <= НайденныеСтроки.ВГраница() Цикл
					...
					ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
						СтрЗаменить(
							ТекстОшибкиДублей, 
							"%Значение%", 
							?(ЗначениеЗаполнено(НайденнаяСтрока.Значение), НайденнаяСтрока.Значение, НСтр("ru='<Пустое значение>';uk='<Порожнє значення>'"))), 
						Ссылка, 

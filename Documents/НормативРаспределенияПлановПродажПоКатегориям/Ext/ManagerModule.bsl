...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании) Экспорт
	...
	Если ПравоДоступа("Добавление", Метаданные.Документы.НормативРаспределенияПлановПродажПоКатегориям) Тогда
		...
		КомандаСоздатьНаОсновании.Идентификатор = Метаданные.Документы.НормативРаспределенияПлановПродажПоКатегориям.ПолноеИмя();
		КомандаСоздатьНаОсновании.Представление = ВводНаОсновании.ПредставлениеОбъекта(Метаданные.Документы.НормативРаспределенияПлановПродажПоКатегориям);
...
Функция ПолучитьРеквизитыДляНормативов(УчитыватьФункциональныеОпции = Истина) Экспорт 
	...
	СтруктураРеквизита.Вставить("Представление", НСтр("ru='Производитель';uk='Виробник'"));
	...
	СтруктураРеквизита.Вставить("Представление", НСтр("ru='Марка (бренд)';uk='Марка (бренд)'"));
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеКоллекциями") ИЛИ НЕ УчитыватьФункциональныеОпции Тогда
		...
		СтруктураРеквизита.Вставить("Представление", НСтр("ru='Коллекция (сезон)';uk='Колекція (сезон)'"));
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьСезонныеКоэффициенты") ИЛИ НЕ УчитыватьФункциональныеОпции Тогда
		...
		СтруктураРеквизита.Вставить("Представление",  НСтр("ru='Сезонная группа';uk='Сезонна група'"));
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьЦеновыеГруппы") ИЛИ НЕ УчитыватьФункциональныеОпции Тогда
		...
		СтруктураРеквизита.Вставить("Представление", НСтр("ru='Ценовая группа';uk='Цінова група'"));
...
Процедура ПересчитатьПоказателиПоНормативамРаспределения(ТаблицаРезультата, ИменаПолейПоказателей, РаспределятьПоНоменклатуре = Истина) Экспорт 
	...
	Для каждого Колонка Из ТаблицаРезультата.Колонки Цикл
		...
		Если ИменаПолейПоказателей.Найти(Колонка.Имя) <> Неопределено
			...
			ИЛИ Колонка.Имя = "Характеристика" Тогда
...
Процедура СопоставитьЗагружаемыеДанные(АдресЗагружаемыхДанных, АдресТаблицыСопоставления, СписокНеоднозначностей, ПолноеИмяТабличнойЧасти, ДополнительныеПараметры) Экспорт
	...
	|		ПО (ТаблицаЗначений.Наименование ПОДОБНО ДанныеДляСопоставления.Значение)
	|			%ТекстОтбора%
	|ГДЕ

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Период = НСтр("ru='в среднем за день';uk='в середньому за день'");
...
Процедура СформироватьСписокПериодов()
	...
	Элементы.Период.СписокВыбора.Добавить(НСтр("ru='в среднем за день';uk='в середньому за день'"));
	Элементы.Период.СписокВыбора.Добавить(НСтр("ru='в среднем за неделю';uk='в середньому за тиждень'"));
	Элементы.Период.СписокВыбора.Добавить(НСтр("ru='в среднем за месяц';uk='в середньому за місяць'"));

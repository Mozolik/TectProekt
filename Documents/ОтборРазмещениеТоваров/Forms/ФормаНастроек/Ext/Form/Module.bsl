...
Процедура ЗакрытьССохранением(Команда)
	...
	ОчиститьСообщения();
	ОшибкаПроверки = Ложь;
	ШаблонСообщения = НСтр("ru='Поле ""%ИмяПоля%"" не заполнено.';uk='Поле ""%ИмяПоля%"" не заповнено.'");
	...
	Если Элементы.НастройкиЗаданияНаОтбор.Видимость Тогда
		...
		Если НастройкаФормированияПоРабочимУчасткам = "ПоОдномуРабочемуУчастку" 
			...
			ТекстСообщения = СтрЗаменить(ШаблонСообщения,"%ИмяПоля%",НСтр("ru='Рабочий участок';uk='Робоча ділянка'"));
	...
	Если Элементы.НастройкиЗаданияНаОтбор.Видимость Тогда
		...
		Если ОграничиватьПоВесу
			...
			ТекстСообщения = СтрЗаменить(ШаблонСообщения,"%ИмяПоля%",НСтр("ru='Ограничение по весу';uk='Обмеження за вагою'"));
		...
		Если ОграничиватьПоОбъему
			...
			ТекстСообщения = СтрЗаменить(ШаблонСообщения,"%ИмяПоля%",НСтр("ru='Ограничение по объему';uk='Обмеження за об''ємом'"));
	...
	Если Элементы.ГруппаИсполнитель.Видимость 
		...
		ТекстСообщения = СтрЗаменить(ШаблонСообщения,"%ИмяПоля%",НСтр("ru='Исполнитель';uk='Виконавець'"));
...
Процедура УстановитьВидимость()
	...
	Элементы.ГруппаПереупаковка.Видимость 	= (ВладелецНастроек = "УправлениеОтгрузкой")
												   И (Операция = "ФормированиеЗаданий");
	//
	Элементы.ГруппаНастройкиВыборки.Видимость = Элементы.ПоВсейНоменклатуре.Видимость
											Или Элементы.ПоВсемРаспоряжениям.Видимость;
											
	Если Не СкладыСервер.ИспользоватьРабочиеУчастки(Склад, Помещение) Тогда
		Элементы.ГруппаНастройкиПоРабочимУчасткамЛево.Видимость = Ложь;
...
Процедура УстановитьДоступность()
	...
	Если НастройкаФормированияПоРабочимУчасткам = "СРазбиениемПоРабочимУчасткам" Тогда
		...
		Элементы.ГруппаНастройкиЛевоОграничения.ТекущаяСтраница  = Элементы.СтраницаОрганичиватьПустая;
	Иначе

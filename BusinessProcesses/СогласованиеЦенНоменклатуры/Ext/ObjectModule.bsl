...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(Предмет) Тогда
		...
		Если Выборка.ЕстьОшибкиСогласован Тогда
			...
			ТекстОшибки = НСтр("ru='Документ %Предмет% не нуждается в согласовании';uk='Документ %Предмет% не потребує погодження'");
		...
		ИначеЕсли Выборка.ПометкаУдаления Тогда
			...
			ТекстОшибки = НСтр("ru='Документ %Предмет% не может быть согласован, т.к. помечен на удаление';uk='Документ %Предмет% не може бути погоджений, т. я. позначений на вилучення'");
			ТекстОшибки = СтрЗаменить(ТекстОшибки, "%Предмет%", Выборка.Предмет);

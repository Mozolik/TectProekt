...
Функция ПервыйВариант()
	...
	СвойстваВарианта.Вставить("Заголовок",
		НСтр("ru='Даты запрета загрузки данных по информационным базам';uk='Дати заборони завантаження даних по інформаційним базам'"));
	
	СвойстваВарианта.Вставить("Описание",
		НСтр("ru='Выводит даты запрета загрузки для объектов, сгруппированные по информационным базам.';uk='Виводить дати заборони завантаження для об''єктів, згруповані з інформаційних баз.'"));
...
Функция ВторойВариант()
	...
	Если Свойства.ПоказыватьРазделы И НЕ Свойства.ВсеРазделыБезОбъектов Тогда
		...
		Заголовок = НСтр("ru='Даты запрета загрузки данных по разделам и объектам';uk='Дати заборони завантаження даних по розділах і об''єктах'");
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета загрузки, сгруппированные по разделам с объектами.';uk='Виводить дати заборони завантаження, згруповані за розділами з об''єктами.'");
		
	ИначеЕсли Свойства.ВсеРазделыБезОбъектов Тогда
		ИмяВарианта = "ДатыЗапретаЗагрузкиПоРазделамДляПользователей";
		Заголовок = НСтр("ru='Даты запрета загрузки данных по разделам';uk='Дати заборони завантаження даних по розділах'");
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета загрузки, сгруппированные по разделам.';uk='Виводить дати заборони завантаження, згруповані за розділами.'");
	Иначе
		ИмяВарианта = "ДатыЗапретаЗагрузкиПоОбъектамДляПользователей";
		Заголовок = НСтр("ru='Даты запрета загрузки данных по объектам';uk='Дати заборони завантаження даних по об''єктах'");
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета загрузки, сгруппированные по объектам.';uk='Виводить дати заборони завантаження, згруповані по об''єктах.'");
	КонецЕсли;

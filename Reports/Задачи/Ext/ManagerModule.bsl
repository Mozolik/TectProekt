...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Описание = НСтр("ru='Список и сводная статистика по задачам.';uk='Список і зведена статистика за задачами.'");
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ТекущиеЗадачи");
	НастройкиВарианта.Описание = НСтр("ru='Список всех задач в работе к заданному сроку.';uk='Список всіх задач в роботі до заданого строку.'");
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "СправкаПоИсполнительскойДисциплине");
	НастройкиВарианта.Описание = НСтр("ru='Сводка по количеству выполненных в срок и просроченных задачах у исполнителей.';uk='Зведення за кількістю виконаних вчасно і прострочених задач у виконавців.'");
КонецПроцедуры

...
Функция ОбработатьВходящиеПараметры(ФормулировкиЭлементарныхВопросов)
	...
	Заголовок = НСтр("ru='Ответы на вопрос №';uk='Відповіді на запитання №'") + " " + ПолныйКод + " " + НСтр("ru='опроса';uk='опитування'") + " " + НаименованиеОпроса + " " + НСтр("ru='от';uk='від'") + " " + Формат(ДатаОпроса,"ДЛФ=D");

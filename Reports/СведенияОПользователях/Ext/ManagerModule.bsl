...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = 
        ...
        |;uk='Виводить докладні відомості про всіх користувачів,
        |включаючи настройки для входу (якщо зазначені).'");
	...
	НастройкиВарианта.Описание = 
        ...
        |включая настройки для входа (если указаны).'
        |;uk='Виводить докладні відомості про користувачів,
        |включаючи настройки для входу (якщо зазначені).'");
	...
	НастройкиВарианта.Описание = 
        ...
        |включая настройки для входа (если указаны).'
        |;uk='Виводить докладні відомості про зовнішніх користувачів,
        |включаючи настройки для входу (якщо зазначені).'");
	НастройкиВарианта.ФункциональныеОпции.Добавить("ИспользоватьВнешнихПользователей");
КонецПроцедуры

...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Для Каждого  ЭлементВыбора Из НастройкиОтчета.Выбор.Элементы Цикл
		Если СтрНайти(ЭлементВыбора.Заголовок,"Сумма") > 0 Тогда
			ЭлементВыбора.Заголовок = НСтр("ru='Сумма';uk='Сума'") + " (" + ВалютаУпрУчета + ")";
		ИначеЕсли СтрНайти(ЭлементВыбора.Заголовок,"Вес") > 0 Тогда
			ЭлементВыбора.Заголовок = НСтр("ru='Вес';uk='Вага'") + " (" + ЕдиницаИзмеренияВеса + ")";
		ИначеЕсли СтрНайти(ЭлементВыбора.Заголовок,"Объем") > 0 Тогда
			ЭлементВыбора.Заголовок = НСтр("ru='Объем';uk='Об''єм'") + " (" + ЕдиницаИзмеренияОбъема + ")";
		КонецЕсли;
	КонецЦикла;

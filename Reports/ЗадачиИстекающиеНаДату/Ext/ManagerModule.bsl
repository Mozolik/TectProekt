...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Описание = НСтр("ru='Список задач, которые должны быть выполнены к указанной дате.';uk='Список задач, які повинні бути виконані до зазначеної дати.'");
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ЗадачиИстекающиеНаДату");
	НастройкиВарианта.Описание = НСтр("ru='Список задач, которые должны быть выполнены к указанной дате.';uk='Список задач, які повинні бути виконані до зазначеної дати.'");
КонецПроцедуры

...
Функция ПроверитьКлючевыеПараметрыПередПовторнойВыгрузкой(ОтчетЗвит1С, ТекстОшибки, ИмяСхемыЗвит1С, ТипПериода, НомерВПериоде, Год, КодПоЕДРПОУ);
	...
	Если Не ПустаяСтрока(ТекстОшибки) Тогда
		ТекстОшибки = НСтр("ru='Обнаружен отчет ""FREDO ДокМен"" соответсвующий выгружаемому из ""1С"" документу."
"Изменены ключевые параметры, выгрузка отменена.';uk='Виявлено звіт ""FREDO ДокМен"" відповідний документу, що вивантажується з ""1С"" ."

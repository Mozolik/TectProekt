...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Отказ Тогда
		Отчет.ВариантКлассификацииЗадолженности = Справочники.ВариантыКлассификацииЗадолженности.ЭлементПоУмолчанию(Истина);
...
Процедура УправлениеВидимостью()
	...
	Если ТекущаяАктивностьНедоступнаПоФО 
	     Или (Не ПравоДоступа("Чтение",Метаданные.Документы.ЗапланированноеВзаимодействие) И 

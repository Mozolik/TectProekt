...
Процедура СформироватьОтчет(ТаблицаОтчета, ДокументЗаказа) Экспорт
	...
	Если Не ЗначениеЗаполнено(ПартнерДокументаЗаказа) Тогда
		...
		ТекстСообщения = НСтр("ru='В документе ""%1"" не заполнен реквизит ""Партнер""';uk='В документі ""%1"" не заповнений реквізит ""Партнер""'");
	...
	Иначе
		...
		Пока ВыборкаПоНоменклатуре.Следующий() Цикл
			...
			Пока ВыборкаПоХарактеристикам.Следующий() Цикл
				...
				СтруктураСтрокиПозиции.Вставить("ПредставлениеНоменклатуры", НоменклатураКлиентСервер.ПредставлениеНоменклатурыДляПечати(ВыборкаПоНоменклатуре.Номенклатура, ВыборкаПоХарактеристикам.Характеристика));

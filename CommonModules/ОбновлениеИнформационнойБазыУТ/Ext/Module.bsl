...
#Область Версия_3_2_1
	...
	Обработчик.Комментарий = НСтр("ru='Справочник ""Условия цен поставщиков"" трансформируется в справочник ""Виды цен поставщиков"". Данные из соглашения-владельца переносятся в вид цены поставщика.';uk='Довідник ""Умови цін постачальників"" трансформується у довідник ""Види цін постачальників"". Дані угоди власника переносяться у вигляд ціни постачальника.'");
	
	Обработчик = Обработчики.Добавить();
    Обработчик.Версия = "3.2.1.7";
    Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "Справочники.СоглашенияСПоставщиками.ЗаполнитьВидЦеныПоставщика";
	Обработчик.Комментарий = НСтр("ru='Для каждого соглашения с поставщиком создается вид цены поставщика и записывается в реквизит ""Вид цены поставщика"".';uk='Для кожного угоди з постачальником створюється вигляд ціни постачальника і записується в реквізит ""Вид ціни постачальника"".'");
	...
	Обработчик.Комментарий = НСтр("ru='Производится формирование записей по неактуальным записям границ партионного учета в регистре ""Задания к расчету партий"".';uk='Проводиться формування записів по неактуальним записів кордонів партійного обліку в регістрі ""Завдання до розрахунку партій"".'");
	...
	Обработчик.Комментарий = НСтр("ru='Выполняется заполнение статей движения ДС по другой организации';uk='Виконується заповнення статей руху ДС з іншої організації'");
...
#Область Версия_3_2_2
	...
	Обработчик.Комментарий = НСтр("ru='Производится перенос неактуальных границ последовательности ""Расчеты с клиентами"" в регистр заданий.';uk='Проводиться перенесення неактуальних меж послідовності ""Розрахунки з клієнтами"" в регістр завдань.'");

	Обработчик = Обработчики.Добавить();
    Обработчик.Версия = "3.2.2.8";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Процедура = "РегистрыСведений.ЗаданияКРаспределениюРасчетовСПоставщиками.ПеренестиГраницыРасчетаПоставщиков";
	Обработчик.Комментарий = НСтр("ru='Производится перенос неактуальных границ последовательности ""Расчеты с поставщиками"" в регистр заданий.';uk='Проводиться перенесення неактуальних меж послідовності ""Розрахунки з постачальниками"" в регістр завдань.'");
	...
	Обработчик.Комментарий = НСтр("ru='Производится перенос неактуальных границ последовательности ""Формирование исходящих налоговых документов"" в регистр заданий.';uk='Проводиться перенесення неактуальних меж послідовності ""Формування вихідних податкових документів в регістр завдань.'");
	...
	Обработчик.Комментарий = НСтр("ru='Очищает регистр сведений ""Источники данных вариантов анализа целевых показателей"".';uk='Очищає регістр відомостей ""Джерела даних аналізу варіантів цільових показників"".'");
	...
	Обработчик.Комментарий = НСтр("ru='Преобразовывает условия предоставления скидок (наценок) по строке в отбор номенклатуры скидки (наценки).';uk='Перетворює умови надання знижок (націнок) по рядку відбір номенклатури знижки (націнки).'");
	...
	Обработчик.Комментарий = НСтр("ru='Преобразовывает условие предоставления ""За пробную продажу"" в отбор номенклатуры скидки (наценки) с условием""Клиент покупает товар в первый раз"".';uk='Перетворює умову надання ""За пробну продаж"" відбір номенклатури знижки (націнки) з умовою""Клієнт купує товар в перший раз"".'");
	...
	Обработчик.Комментарий = НСтр("ru='Преобразовывает условие предоставления ""За первую продажу партнеру"" в условие ""За накопленный объем продаж"" с нулевым количеством.';uk='Перетворює умову надання ""За першу продаж партнеру"" умова ""За накопичений обсяг продажів"" з нульовим кількістю.'");
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет реквизит ""Используется"" значением ""Истина"" в наборах дополнительных реквизитов.';uk='Заповнює реквізит ""Використовується"" значення ""Істина"" в наборах додаткових реквізитів.'");
...
#Область Версия_3_2_3
	...
	Обработчик.Комментарий = НСтр("ru='Создает основную схему обеспечения. Записывает настройки схемы обеспечения по складам. Удаляет настройки способов обеспечения складов из регистра сведений ""Варианты обеспечения товарами"". Переносит настройки способов обеспечения работ в целом из регистра ""Варианты обеспечения работами"" в справочник ""Номенклатура"". Настройки способов обеспечения товаров и тары в целом детализирует до характеристик.';uk='Створює основну схему забезпечення. Записує параметри схеми забезпечення по складах. Видаляє налаштування способів забезпечення складів з регістра відомостей ""Варіанти забезпечення товарами"". Переносить налаштування способів забезпечення робіт у цілому з регістра ""Варіанти забезпечення роботами"" у довідник ""Номенклатура"". Налаштування способів забезпечення товарів і тари в цілому деталізує до характеристик.'");
...
#КонецОбласти
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ПеремещениеТоваров";
	Обработчик.Комментарий = НСтр("ru='Перезаполнение колонки ""НазначениеОтправителя"" в табличных частях ""Товары"" и ""Серии"" в документе ""Перемещение товаров"".';uk='Перезаполнение колонки ""НазначениеОтправителя"" в табличних частинах ""Товари"" і ""Серії"" документ ""Переміщення товарів"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
...
#Область ОбновлениеВыписки                            
	...
	Обработчик.Комментарий = НСтр("ru='Устанавливает документам списания безналичных денежных средств признак проведения банком.
        |Пока обработчик не завершен, информация об остатках безналичных денежных средств может быть некорректной.'
        |;uk='Встановлює документами списання безготівкових коштів ознака проведення банком.
        |Поки обробник не завершений, інформація про залишки безготівкових грошових коштів може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;    
	...
	Обработчик.Комментарий = НСтр("ru='Переносит движения безналичных денежных средств из выписки в документы поступления и списания.
        |Пока обработчик не завершен, информация об остатках безналичных денежных средств может быть некорректной.'
        |;uk='Переносить руху безготівкових грошових коштів з виписки документів надходження і списання.
        |Поки обробник не завершений, інформація про залишки безготівкових грошових коштів може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;    
	...
	Обработчик.Комментарий = НСтр("ru='Создает документы поступления денежных средств по эквайрингу.
        |Пока обработчик не завершен, информация об остатках безналичных денежных средств может быть некорректной.'
        |;uk='Створює документи надходження грошових коштів еквайрингу.
        |Поки обробник не завершений, інформація про залишки безготівкових грошових коштів може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;    
	...
	Обработчик.Комментарий = НСтр("ru='Перенос движений наличных ДС по хозяйственной операции ""Оплата в другую организацию"".
                                    |Пока работа обработчика не завершена, информация об остатках денежных средств может быть некорректной.'
                                    |;uk='Перенесення рухів готівки ДС по господарській операції ""Оплата в іншу організацію"".
                                    |Поки робота обробника не завершена, інформація про залишки грошових коштів може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.Комментарий = НСтр("ru='Перенос движений наличных ДС по хозяйственной операции ""Возврат в другую организацию"".
                                    |Пока работа обработчика не завершена, информация об остатках денежных средств может быть некорректной.'
                                    |;uk='Перенесення рухів готівки ДС по господарській операції ""Повернення в іншу організацію"".
                                    |Поки робота обробника не завершена, інформація про залишки грошових коштів може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Очистка движений выписки по регистру ""Движения Денежные средства - Денежные средства"" по эквайрингу.';uk='Очищення рухів виписки по регістру ""Руху кошти - Грошові кошти"" еквайрингу.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Очистка движений выписки по регистру ""Движения Денежные средства - Доходы/Расходы"" по эквайрингу.';uk='Очищення рухів виписки по регістру ""Руху кошти - Доходи/Витрати"" еквайрингу.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
...
#Область ЗаполнитьДвиженияДеньгиВПути
	...
	Обработчик.Комментарий = НСтр("ru='Формирование движений платежных документов по безналичному расчету по регистру ""Денежные средства в пути"".
                                ...
                                |;uk='Формування рухів платіжних документів за безготівковим розрахунком з регістру ""Грошові кошти в дорозі"".
	...
	Обработчик.Комментарий = НСтр("ru='Перенос движений выписки по хоз. операции ""Поступление денежных средств с другого счета"".
                                    |Пока работа обработчика не завершена, информация об остатках переводов в пути может быть некорректной.'
                                    |;uk='Перенесення рухів виписки з госп. операції ""Надходження грошових коштів з іншого рахунку"".
                                    |Поки робота обробника не завершена, інформація про залишки переказів в дорозі може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.Комментарий = НСтр("ru='Перенос движений выписки по хоз. операции ""Поступление денежных средств из банка"".
                                    |Пока работа обработчика не завершена, информация об остатках переводов в пути может быть некорректной.'
                                    |;uk='Перенесення рухів виписки з госп. операції ""Надходження грошових коштів з банку"".
                                    |Поки робота обробника не завершена, інформація про залишки переказів в дорозі може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.Комментарий = НСтр("ru='Формирование движений в регистре ""Денежные средства в пути"" по хоз. операции ""Поступление денежных средств из банка"".
                                    |Пока работа обработчика не завершена, информация об остатках переводов в пути может быть некорректной.'
                                    |;uk='Формування рухів у регістрі ""Грошові кошти в дорозі"" з госп. операції ""Надходження грошових коштів з банку"".
                                    |Поки робота обробника не завершена, інформація про залишки переказів в дорозі може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.Комментарий = НСтр("ru='Формирование движений в регистре ""Денежные средства в пути"" по хоз. операции ""Сдача денежных средств в банк"".
                                    |Пока работа обработчика не завершена, информация об остатках переводов в пути может быть некорректной.'
                                    |;uk='Формування рухів у регістрі ""Грошові кошти в дорозі"" з госп. операції ""Здавання коштів в банк"".
                                    |Поки робота обробника не завершена, інформація про залишки переказів в дорозі може бути некоректною.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перенос движений выписки по регистру ""Движения Денежные средства - Доходы\Расходы"".';uk='Перенесення рухів виписки по регістру ""Руху кошти - Доходи\Витрати"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перенос движений выписки по регистру ""Движения денежных средств"".';uk='Перенесення рухів виписки по регістру ""Руху грошових коштів"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
...
#КонецОбласти // ЗаполнитьДвиженияДеньгиВПути
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Корректировка движений регистра ""Движения ""Денежные средства - Доходы\Расходы"" по хоз. операции ""Конвертация валюты"".';uk='Коригування рухів регістра ""Руху ""Грошові кошти - Доходи\Витрати"" з госп. операції ""Конвертація валюти"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения по регистру ""Обеспечение заказов"" для документов.';uk='Заповнює руху по регістру ""Забезпечення замовлень"" для документів.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет движения по регистру ""Расчеты с клиентами"" для документов ""Поступление безналичных денежных средств"", не проведенных банком.';uk='Перезаполняет руху по регістру ""Розрахунки з клієнтами"" для документів ""Надходження безготівкових коштів"", не проведених банком.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет движения по регистру ""Расчеты с поставщиками"" для документов ""Расходный кассовый ордер"", проведенных по заявке.';uk='Перезаполняет руху по регістру ""Розрахунки з постачальниками"" для документів ""Видатковий касовий ордер"", проведених за заявкою.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения по регистру ""Расчеты с поставщиками"" для документов ""Заявка на расходование денежных средств"".';uk='Заповнює руху по регістру ""Розрахунки з постачальниками"" для документів ""Заявка на витрачання грошових коштів"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Корректировка движений документа ""Отчет комиссионера о списании"" по регистру ""Движения ""Номенклатура - Доходы\Расходы"".';uk='Коригування рухів документа ""Звіт комісіонера про списання"" регістру ""Руху ""Номенклатура - Доходи\Витрати"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет раздел учета в движениях по регистру ""Себестоимость товаров"" для собственных товаров.';uk='Перезаполняет розділ обліку в рухах по регістру ""Собівартість товарів"" для власних товарів.'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ПоступлениеБезналичныхДенежныхСредств";
	Обработчик.Комментарий = НСтр("ru='Для документов ""Поступление безналичных ДС"" заменяется хозяйственная операция ""Внутреннее поступление ДС"".';uk='Для документів ""Надходження безготівкових ДС"" замінюється господарська операція ""Внутрішнє надходження ДС"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.Комментарий = НСтр("ru='Распроводит и помечает на удаление документы ""Приходный ордер на товары"" с типом операции ""Возврат непринятых товаров"" на неордерных при отражении излишков и недостач складах, при этом происходит перенос товаров в новые непроведенные документы ""Оприходование излишков товаров"".';uk='Распроводит і позначає на видалення документи ""Прибутковий ордер на товари"" з типом операції ""Повернення пропущених товарів"" на неордерных при відображенні надлишків і нестач складах, при цьому відбувається перенесення товарів у нові непроведені документи ""Оприбуткування лишків товарів"".'");
    Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
...
#Область Версия_3_2_2
    ...
    |До завершения работы обработчика обновления документы находятся в некорректном состоянии.'
    |;uk='Змінює в документах ""Заявка на витрачання ДС"" операцію ""Інші витрати"" на ""Інші витрати"". 
    |До завершення роботи оброблювача оновлення документи знаходяться в некоректному стані.'");
	...
	Обработчик.Комментарий = НСтр("ru='Формирование движений по регистру ""Денежные средства в пути"" по хоз. операции ""Поступление с другого счета"".
                                   |Пока работа обработчика не завершена, информация об остатках переводов в пути может быть некорректной.'
                                   |;uk='Формування рухів по регістру ""Грошові кошти в дорозі"" з госп. операції ""Надходження з іншого рахунку"".
                                   |Поки робота обробника не завершена, інформація про залишки переказів в дорозі може бути некоректною.'");
    ...
    |До завершения работы обработчика обновления, документы находятся в некорректном состоянии.'
    |;uk='Заповнює в документах ""Надходження безготівкових ДС"" з операцією ""Інше надходження"" табличну частину ""Розшифровка платежу"". 
    |До завершення роботи оброблювача оновлення, документи знаходяться в некоректному стані.'");
    ...
    |;uk='Переносить руху документа ""Заявка на витрачання ДС"" з регістра Руху Грошові кошти - Інші активи/пасиви"" регістр ""Руху кошти - Доходи/Витрати"". 
    ...
    |Очищає руху по регістру накопичення ""Розрахунки з клієнтами за документами"", де реєстратором є замовлення.'");
    ...
    |;uk='Оновлює подання в поле агрегаті ВидДляСписка для виведення контактної інформації
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Формирует движения документов ""Аннулирование подарочных сертификатов"" по регистру накопления ""Движения ""Контрагент - Доходы\Расходы"""".';uk='Формує руху документів ""Анулювання подарункових сертифікатів"" по регістру накопичення ""Руху ""Контрагент - Доходи\Витрати"""".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ВозвратТоваровПоставщику";
	Обработчик.Комментарий = НСтр("ru='Очищает статусы в документах ""Возврат товаров поставщику""';uk='Очищає статуси в документах ""Повернення товарів постачальнику""'");
    ...
    |До завершения работы обработчика обновления движения документов находятся в некорректном состоянии.'
    |;uk='Переносить руху документа ""Надходження безготівкових ДС"" з регістра Руху Грошові кошти - Інші активи/пасиви"" регістр ""Руху кошти - Доходи/Витрати"". 
    |До завершення роботи оброблювача поновлення руху документів знаходяться в некоректному стані.'");
    ...
    |;uk='Замінює вимір ""Аналітика обліку за партнерам"" з урахуванням договору.
    |Видаляє руху регістру, де розрахунковим документом є ""Замовлення постачальнику"".'");
    ...
    |;uk='Заповнюється реквізит ""Тип суми"" в документі ""Списання безготівкових ДС""
    ...
    |До завершения работы обработчика обновления движения документов находятся в некорректном состоянии.'
    |;uk='Переносить руху документа ""Прибутковий касовий ордер"" з регістра Руху Грошові кошти - Інші активи/пасиви"" регістр ""Руху кошти - Доходи/Витрати"". 
    |До завершення роботи оброблювача поновлення руху документів знаходяться в некоректному стані.'");
    ...
    Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
    Обработчик.БлокируемыеОбъекты = "Документ.РеализацияТоваровУслуг";
    Обработчик.Комментарий = НСтр("ru='Заполняет способ доставки по умолчанию (""Самовывоз"") в документах ""Реализация товаров и услуг"", оформленных по заказам.';uk='Заповнює спосіб доставки (""Самовивіз"") в документах ""Реалізація товарів і послуг"", оформлених за замовленнями.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.СписаниеБезналичныхДенежныхСредств";
	Обработчик.Комментарий = НСтр("ru='Заполняет реквизит ""Дата авансового отчета"".';uk='Заповнює реквізит ""Дата звіту"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ЗаявкаНаРасходованиеДенежныхСредств";
	Обработчик.Комментарий = НСтр("ru='Заполняет реквизит ""Дата авансового отчета"" в документе ""Заявка на расходование денежных средств"".';uk='Заповнює реквізит ""Дата звіту"" документ ""Заявка на витрачання грошових коштів"".'");
    ...
    |по хозяйственным операциям кредитов, депозитов, займов.'
    |;uk='Заповнюється реквізит ""Тип суми"" в документі ""Надходження безготівкових ДС"" 
    |за господарськими операціями кредитів, депозитів, позик.'");
    ...
    Обработчик.ЗапускатьТолькоВГлавномУзле = Истина;
    Обработчик.Комментарий = НСтр("ru='Переносит расхождения из  документа ""Реализация товаров и услуг"" в документ ""Акт о расхождениях после отгрузки"".';uk='Переносить розбіжності з документа ""Реалізація товарів і послуг"" документ ""Акт про розбіжності після відвантаження"".'");
    ...
    |До завершения работы обработчика обновления, документы находятся в некорректном состоянии.'
    |;uk='Заповнює документи ""Заявка на витрачання ДС"" з операцією ""Інший витрата"" табличну частину ""Розшифровка платежу"". 
    |До завершення роботи оброблювача оновлення, документи знаходяться в некоректному стані.'");
    ...
    |До завершения работы обработчика обновления документы находятся в некорректном состоянии.'
    |;uk='Змінює в документах ""Надходження безготівкових ДС"" операцію ""Інші доходи"" на ""Інше надходження"". 
    |До завершення роботи оброблювача оновлення документи знаходяться в некоректному стані.'");
    ...
    |До завершения работы обработчика обновления документы находятся в некорректном состоянии.'
    |;uk='Заповнює в документах ""Списання безготівкових ДС"" з операцією ""Інший витрата"" табличну частину ""Розшифровка платежу"". 
    |До завершення роботи оброблювача оновлення документи знаходяться в некоректному стані.'");
    ...
    |До завершения работы обработчика обновления движения документов находятся в некорректном состоянии.'
    |;uk='Переносить руху документа ""Списання безготівкових ДС"" з регістра Руху Грошові кошти - Інші активи/пасиви"" регістр ""Руху кошти - Доходи/Витрати"". 
    |До завершення роботи оброблювача поновлення руху документів знаходяться в некоректному стані.'");
    ...
    |До завершения работы обработчика обновления документы находятся в некорректном состоянии.'
    |;uk='Змінює в документах ""Списання безготівкових ДС"" операцію ""Інші витрати"" на ""Інші витрати"". 
    |До завершення роботи оброблювача оновлення документи знаходяться в некоректному стані.'");
	...
	Обработчик.БлокируемыеОбъекты = "Документ.ВозвратТоваровПоставщику";
	Обработчик.ЗапускатьТолькоВГлавномУзле = Истина;
	Обработчик.Комментарий = НСтр("ru='Переносит расхождения из документа ""Возврат товаров поставщику"" в документ ""Акт о расхождениях после отгрузки"".';uk='Переносить розбіжності з документа ""Повернення товарів постачальнику"" документ ""Акт про розбіжності після відвантаження"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перепроводит документы по регистру сведений ""Суммы документов в валюте регл"".';uk='Перепроводит документи по регістрі відомостей ""Суми документів в іноземній валюті регл"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ПеремещениеТоваров";
	Обработчик.Комментарий = НСтр("ru='Заполняет способ доставки по умолчанию (""Самовывоз"") в документах ""Перемещение товаров"",  оформленных по заказам.';uk='Заповнює спосіб доставки (""Самовивіз"") в документах ""Переміщення товарів"", оформлених за замовленнями.'");
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет дату отгрузки в документах ""Заказ клиента"" в статусе ""На согласовании"" согласно гарантированному сроку отгрузки по основному способу обеспечения.';uk='Заповнює дату відвантаження в документах ""Замовлення клієнта"" в статус ""узгодження"" згідно гарантованого терміну відвантаження за основним способом забезпечення.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ПоступлениеБезналичныхДенежныхСредств";
	Обработчик.Комментарий = НСтр("ru='Заполняет новый реквизит ""Организация"" в табличной части ""Расшифровка платежа"" документа ""Поступление безналичных ДС"".';uk='Заповнює новий реквізит ""Організація"" в табличній частині ""Розшифровка платежу"" документа ""Надходження безготівкових ДС"".'");
    ...
    |;uk='Розбиває рядок табличної частини ""Товари"" документів ""Замовлення на зборку/розбирання"", якщо пов''язаної накладної після перенесення серій змінилися коди рядків у табличній частині ""Товари"", З накладної переносяться нові коди рядків. До завершення роботи оброблювача оновлення 
    ...
    |;uk='Розбиває документи ""Замовлення на збірку (розбирання)"", в яких не вказана серія комплекту і за якими оформлені ""Збірка (розбирання) товарів"":
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ВнутреннееПотреблениеТоваров";
	Обработчик.Комментарий = НСтр("ru='Очищает статусы в документах ""Внутреннее потребление товаров"".';uk='Очищає статуси в документах ""Внутрішнє споживання товарів"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.СборкаТоваров";
	Обработчик.Комментарий = НСтр("ru='Удаляет статус ""К сборке/разборке"" в документах ""Сборка (разборка) товаров"".';uk='Видаляє статус ""До збірці/розбиранні"" в документах ""Збірка (розбирання) товарів"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.СписаниеБезналичныхДенежныхСредств";
	Обработчик.Комментарий = НСтр("ru='Заполняет новый реквизит ""Организация"" в табличной части ""Расшифровка платежа"" документа ""Списание безналичных ДС"".';uk='Заповнює новий реквізит ""Організація"" в табличній частині ""Розшифровка платежу"" документа ""Списання безготівкових ДС"".'");
    ...
    |До завершення роботи оброблювача оновлення робочих місцях ""Внутрішні товароруху"", ""Складання (розбирання) товарів"", ""Переміщення товарів"", ""Внутрішні споживання товарів"" не будуть відображатися документи.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перепроводит по регистру ""Движения ""Денежные средства - Контрагент"""" документы ""Заявка на расход ДС"", ""Расходный кассовый ордер"", ""Списание безналичных ДС"".Формирует по регистру движения документов реализации\возврата подарочных сертификатов.';uk='Перепроводит по регістру ""Руху ""Грошові кошти - Контрагент"","" документи ""Заявка на витрату ДС"", ""Видатковий касовий ордер"", ""Списання безготівкових ДС"".Формує по регістру руху документів реалізації\повернення подарункових сертифікатів.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения документа ""Реализация товаров и услуг"" по регистру ""Товары переданные на комиссию"".';uk='Заповнює руху документа ""Реалізація товарів і послуг"" регістру ""Товари передані на комісію"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения по регистру ""Переданная возвратная тара"" для документов ""Реализация товаров и услуг"" в статусе ""К отгрузке""';uk='Заповнює руху по регістру ""Передана поворотна тара"" для документів ""Реалізація товарів і послуг"" в статус ""До відвантаження""'");
	...
	Обработчик.Комментарий = НСтр("ru='В Задании на перевозку заполняются статус ""К погрузке"" для заданий, по которым имеются неотгруженные ордера.';uk='У Завданні на перевезення заповнюються статус ""До навантаження"" для завдань, за якими є неотгруженные ордера.'");
    ...
    |;uk='Коригується регістр накопичення ""Руху Контрагент - Контрагент"" за документами ""Взаємозалік заборгованості"".
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ЗаданиеНаПеревозку";
	Обработчик.Комментарий = НСтр("ru='Заполняет в ранее оформленных документах ""Задания на перевозку"" операцию ""Доставка с нашего склада"".';uk='Заповнює раніше оформлених документах ""Завдання на перевезення"" операцію ""Доставка з нашого складу"".'");
	...
	Обработчик.Комментарий = НСтр("ru='Обновляет состояния заказов клиентов в регистре ""Состояния заказов клиентов"".';uk='Оновлює стану замовлень клієнтів у регістрі ""Стану замовлень клієнтів"".'");
...
#Область Версия_3_2_3
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Исправляет движения по регистру накопления ""Денежные средства у подотчетных лиц"". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Виправляє руху по регістру накопичення ""Грошові кошти у підзвітних осіб"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
    ...
    |а також реквізит ""Підрозділ"" у табличній частині ""РаспределениеРасходов"" документа ""Розподіл витрат майбутніх періодів"".
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
    Обработчик.Комментарий = НСтр("ru='Исправляет движения документов в регистре накопления ""Товары к оформлению излишков и недостач"".';uk='Виправляє руху документів в регістрі накопичення ""Товари до оформлення надлишків і недостач"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет статью и аналитику пассивов в регистре ""Движения Доходы/Расходы - Прочие активы/пассивы"" для налогов и взносов с оплаты труда.';uk='Перезаполняет статтю і аналітику пасивів у регістрі ""Руху Доходи/Витрати - Інші активи/пасиви"" для податків і внесків з оплати праці.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Исправляет движения по регистру накопления ""Товары в ячейках"". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Виправляє руху по регістру накопичення ""Товари в комірках"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Исправляет движения по регистру накопления ""Товары к отбору"". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Виправляє руху по регістру накопичення ""Товари до відбору"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Корректировка движений регистра ""Движения ""Номенклатура - Номенклатура"".';uk='Коригування рухів регістра ""Руху ""Номенклатура - це Номенклатура"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.ЗаявкаНаРасходованиеДенежныхСредств";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет в документе статью активов и пассивов при оплате имущественных налогов на предопределенную статью ""Налоги"".';uk='Перезаполняет в документі статті активів і пасивів при оплату майнових податків на визначену статтю ""Податки"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "Документ.СписаниеБезналичныхДенежныхСредств";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет в документе статью активов и пассивов при оплате имущественных налогов, НДФЛ и страховых взносов на предопределенную статью ""Налоги"".';uk='Перезаполняет в документі статті активів і пасивів при оплату майнових податків, ПДФО і страхових внесків на визначену статтю ""Податки"".'");
	...
	Обработчик.Комментарий = НСтр("ru='Переформирует записи в регистре """"Варианты переупаковки""""';uk='Переформують запису в регістрі """"Варіанти перепакування""""'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перепроводит документы по регистру сведений ""Суммы документов в валюте регл"", если для услуг из документа нет движений по регистру.';uk='Перепроводит документи по регістрі відомостей ""Суми документів в іноземній валюті регл"", якщо для послуг з документа немає рухів по регістру.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения по регистру ""Товары к оформлению поступлений"" для документов товародвижения в статусе ""К отгрузке/К сборке""';uk='Заповнює руху по регістру ""Товари до оформлення надходжень"" для документів товароруху в статус ""До відвантаження/складання""'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Исправляет движения по регистру накопления ""Товары к отгрузке"". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Виправляє руху по регістру накопичення ""Товари до відвантаження"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Исправляет движения по регистру накопления ""Обеспечение заказов"". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Виправляє руху по регістру накопичення ""Забезпечення замовлень"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
    Обработчик.Комментарий = НСтр("ru='Исправляет движения по регистру ""Движение товаров"".';uk='Виправляє руху по регістру ""Рух товарів"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Перезаполняет в регистре статьи при начислении и оплате имущественных налогов, НДФЛ и страховых взносов на предопределенную статью ""Налоги"". Перезаполняет в регистре статьи, когда в документе статья указана, а в движениях - нет.';uk='Перезаполняет в регістрі статті при нарахуванні та оплату майнових податків, ПДФО і страхових внесків на визначену статтю ""Податки"". Перезаполняет в регістрі статті, коли в документі вказана стаття, а в рухах - ні.'");
    ...
    |;uk='Оновлюється регістр накопичення ""кошти до виплати"". 
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Изменяет движения по регистру накопления ""Свободные остатки"". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Змінює руху по регістру накопичення ""Вільні залишки"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
    ...
    |Пока работа обработчика не завершена, информация в регистре некорректна.'
    |;uk='Коригування записів регістру накопичення ""Руху Контрагент - Доходи\Витрати"" для документів ""Розрахунок курсових різниць"".
    |Поки робота обробника не завершена, інформація в регістрі некоректна.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Обновляется регистр накопления """"Движения серий товаров"""". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Оновлюється регістр накопичення """"Руху серій товарів"""". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
    ...
    |;uk='Коригує руху по регістру ""Руху грошових коштів"".
    ...
    |Пока обработчик не завершен, данные в регистре некорректны.'
    |;uk='Коригує руху по регістру ""Руху кошти доходи витрати"".
    |Поки обробник не завершений, дані в регістрі некоректні.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет движения по регистру ""График поступления товаров"". Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Заповнює руху по регістру ""Графік надходження товарів"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "РегистрСведений.СостоянияИРеквизитыДоставки";
	Обработчик.Комментарий = НСтр("ru='Очищает ошибочные записи регистра сведений ""Состояния и реквизиты доставки""';uk='Очищає помилкові записи реєстру відомостей ""Стану і реквізити доставки""'");
    ...
    |;uk='Перепроводятся ""Прибуткові касові ордера"" по регістру накопичення ""Грошові кошти в дорозі"" господарської операції ""Конвертація валюти"".
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет измерение ""Серия"" в регистре ""Заказы на перемещение"" для серий со статусом указания серий равном 10 (серии по которым учитываются остатки).';uk='Заповнює вимір ""Серія"" в регістрі ""Замовлення на переміщення"" для серій зі статусом вказівки серій рівному 10 (серії за якими обліковуються залишки).'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Изменяет движения по регистру накопления ""Обеспечение заказов работами"".  Пока работа обработчика не завершена, информация в регистре некорректна.';uk='Змінює руху по регістру накопичення ""Забезпечення замовлень роботами"". Поки робота обробника не завершена, інформація в регістрі некоректна.'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Исправляет неверные движения документов в регистре накопления ""Заказы клиентов"".';uk='Виправляє неправильні руху документів в регістрі накопичення ""Замовлення клієнтів"".'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Заполняет измерение ""Серия"" в регистре ""Заказы на внутреннее потребление"" для серий со статусом указания серий равном 10 (серии указываются при планировании отгрузки).';uk='Заповнює вимір ""Серія"" в регістрі ""Замовлення на внутрішнє споживання"" для серій зі статусом вказівки серій рівному 10 (серії вказуються при плануванні відвантаження).'");
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Корректирует движения регистра ""Закупки"" для документов ""Возврат товаров поставщику"".';uk='Коригує руху регістра ""Закупівлі"" для документів ""Повернення товарів постачальнику"".'");
...
#Область Версия_3_2_4
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "РегистрНакопления.НДССоставПоставкиДляРегистрацииВходящихНалоговыхДокументов";
	Обработчик.Комментарий = НСтр("ru='Переформировывает движения по регистру ""НДС: Состав поставки для регистрации входящих налоговых документов"" по документам, которые формируют расходные движения.';uk='Переформировывает руху по регістру ""ПДВ: Склад поставки для реєстрації вхідних податкових документів"" за документами, які формують витратні руху.'");
...
#Область Версия_3_2_7
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Переформировывает движения по регистру ""НДС: Состав поставки для регистрации входящих налоговых документов"", которые сформированы документом ""Возврат товаров поставщику"" и ""Регистрация входящего налогового документа""';uk='Переформировывает руху по регістру ""ПДВ: Склад поставки для реєстрації вхідних податкових документів"", які сформовані документом ""Повернення товарів постачальнику"" і ""Реєстрація вхідного податкового документа""'");
	Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;
	...
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.БлокируемыеОбъекты = "";
	Обработчик.Комментарий = НСтр("ru='Переформировывает движения по регистру ""НДС: Номенклатурный состав для налоговых накладных"", которые сформированы документом ""Возврат товаров от клиента""';uk='Переформировывает руху по регістру ""ПДВ: Номенклатурний склад для податкових накладних"", які сформовані документом ""Повернення товарів від клієнта""'");
	Обработчик.НеЗаполнятьДанныеВОбработчикеПодредакции = Истина;

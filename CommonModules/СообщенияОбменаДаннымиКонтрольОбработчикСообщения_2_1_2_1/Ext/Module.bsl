...
Функция ПредставлениеНастройкаСинхронизацииШаг1()
	...
	Возврат НСтр("ru='Настройка синхронизации, шаг 1.';uk='Настройка синхронізації, крок 1.'");
	
КонецФункции

Функция ПредставлениеНастройкаСинхронизацииШаг2()
	
	Возврат НСтр("ru='Настройка синхронизации, шаг 2.';uk='Настройка синхронізації, крок 2.'");
	
КонецФункции

Функция ПредставлениеЗагрузкаСообщенияОбмена()
	
	Возврат НСтр("ru='Загрузка сообщения обмена.';uk='Завантаження повідомлення обміну.'");
	
КонецФункции

Функция ПредставлениеПолучениеДанныхКорреспондента()
	
	Возврат НСтр("ru='Получение данных корреспондента.';uk='Отримання даних кореспондента.'");
	
КонецФункции

Функция ПредставлениеПолучениеОбщихДанныхУзловКорреспондента()
	
	Возврат НСтр("ru='Получение общих данных узлов корреспондента.';uk='Отримання загальних даних вузлів кореспондента.'");
	
КонецФункции

Функция ПредставлениеПолучениеПараметровУчетаКорреспондента()
	
	Возврат НСтр("ru='Получение параметров учета корреспондента.';uk='Отримання параметрів обліку кореспондента.'");

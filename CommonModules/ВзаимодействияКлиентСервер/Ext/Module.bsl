...
Функция СформироватьИнформационнуюНадписьКоличествоСимволовСообщений(ОтправлятьВТранслите, ТекстСообщения) Экспорт
	...
	ШаблонТекстаСообщения = НСтр("ru='Сообщение - %1, осталось символов - %2';uk='Повідомлення - %1, залишилось символів - %2'");
...
Функция ПолучитьСписокКодировок() Экспорт
	...
	СписокКодировок.Добавить("ibm852",       НСтр("ru='ibm852 (Центральноевропейская DOS)';uk='ibm852 (Центральноєвропейська DOS)'"));
	СписокКодировок.Добавить("ibm866",       НСтр("ru='ibm866 (Кириллица DOS)';uk='ibm866 (Кирилиця DOS)'"));
	СписокКодировок.Добавить("iso-8859-1",   НСтр("ru='iso-8859-1 (Западноевропейская ISO)';uk='iso-8859-1 (Західноєвропейська ISO)'"));
	СписокКодировок.Добавить("iso-8859-2",   НСтр("ru='iso-8859-2 (Центральноевропейская ISO)';uk='iso-8859-2 (Центральноєвропейська ISO)'"));
	СписокКодировок.Добавить("iso-8859-3",   НСтр("ru='iso-8859-3 (Латиница 3 ISO)';uk='iso-8859-3 (Латиниця 3 ISO)'"));
	СписокКодировок.Добавить("iso-8859-4",   НСтр("ru='iso-8859-4 (Балтийская ISO)';uk='iso-8859-4 (Балтійська ISO)'"));
	СписокКодировок.Добавить("iso-8859-5",   НСтр("ru='iso-8859-5 (Кириллица ISO)';uk='iso-8859-5 (Кирилиця ISO)'"));
	СписокКодировок.Добавить("iso-8859-7",   НСтр("ru='iso-8859-7 (Греческая ISO)';uk='iso-8859-7 (Грецька ISO)'"));
	СписокКодировок.Добавить("iso-8859-9",   НСтр("ru='iso-8859-9 (Турецкая ISO)';uk='iso-8859-9 (Турецька ISO)'"));
	СписокКодировок.Добавить("iso-8859-15",  НСтр("ru='iso-8859-15 (Латиница 9 ISO)';uk='iso-8859-15 (Латиниця 9 ISO)'"));
	СписокКодировок.Добавить("koi8-r",       НСтр("ru='koi8-r (Кириллица KOI8-R)';uk='koi8-r (Кирилиця KOI8-R)'"));
	СписокКодировок.Добавить("koi8-u",       НСтр("ru='koi8-u (Кириллица KOI8-U)';uk='koi8-u (Кирилиця KOI8-U)'"));
	СписокКодировок.Добавить("us-ascii",     НСтр("ru='us-ascii США';uk='us-ascii США'"));
	СписокКодировок.Добавить("utf-8",        НСтр("ru='utf-8 (Юникод UTF-8)';uk='utf-8 (Юнікод UTF-8)'"));
	СписокКодировок.Добавить("windows-1250", НСтр("ru='windows-1250 (Центральноевропейская Windows)';uk='windows-1250 (Центральноєвропейська Windows)'"));
	СписокКодировок.Добавить("windows-1251", НСтр("ru='windows-1251 (Кириллица Windows)';uk='windows-1251 (Кирилиця Windows)'"));
	СписокКодировок.Добавить("windows-1252", НСтр("ru='windows-1252 (Западноевропейская Windows)';uk='windows-1252 (Західноєвропейська Windows)'"));
	СписокКодировок.Добавить("windows-1253", НСтр("ru='windows-1253 (Греческая Windows)';uk='windows-1253 (Грецька Windows)'"));
	СписокКодировок.Добавить("windows-1254", НСтр("ru='windows-1254 (Турецкая Windows)';uk='windows-1254 (Турецька Windows)'"));
	СписокКодировок.Добавить("windows-1257", НСтр("ru='windows-1257 (Балтийская Windows)';uk='windows-1257 (Балтійська Windows)'"));
...
Функция ПолучитьМассивОписанияВозможныхКонтактов() Экспорт
	...
	ДобавитьЭлементМассиваОписанияВозможныхТиповКонтактов(МассивВозможныеКонтакты,
		Тип("СправочникСсылка.Пользователи"),Ложь,"Пользователи","Пользователи",Ложь,Ложь,"",Ложь,"", "Наименование");
...
Функция ПолучитьСтроковоеПредставлениеРазмераФайла(РазмерВБайтах) Экспорт
	...
	Если РазмерМб > 1 Тогда
		СтрокаРазмер = Формат(РазмерМб,"ЧДЦ=1") + " " + НСтр("ru='Мб';uk='Мб'");
	Иначе
		СтрокаРазмер = Формат(РазмерВБайтах /1024,"ЧДЦ=0; ЧН=0") + " " + НСтр("ru='Кб';uk='Кб'");
	КонецЕсли;
...
Функция СписокСтатусов() Экспорт
	...
	СписокСтатусов.Добавить("Все", НСтр("ru='Все';uk='Всі'"));
	СписокСтатусов.Добавить("КРассмотрению", НСтр("ru='К рассмотрению';uk='До розгляду'"));
	СписокСтатусов.Добавить("Отложенные", НСтр("ru='Отложенные';uk='Відстрочені'"));
	СписокСтатусов.Добавить("Рассмотренные", НСтр("ru='Рассмотренные';uk='Розглянуті'"));
...
Функция СписокОтборовПоТипуВзаимодействий(ТолькоПочта) Экспорт
	...
	СписокОтборов.Добавить("Все", НСтр("ru='Все';uk='Всі'"));
	СписокОтборов.Добавить("ВсеПисьма", НСтр("ru='Все письма';uk='Всі листи'"));
	Если Не ТолькоПочта Тогда
		СписокОтборов.Добавить("Встречи", НСтр("ru='Встречи';uk='Зустрічі'"));
		СписокОтборов.Добавить("ТелефонныеЗвонки", НСтр("ru='Телефонные звонки';uk='Телефонні дзвінки'"));
		СписокОтборов.Добавить("ЗапланированныеВзаимодействия", НСтр("ru='Запланированные взаимодействия';uk='Заплановані взаємодії'"));
		СписокОтборов.Добавить("СообщенияSMS", НСтр("ru='Сообщения SMS';uk='Повідомлення SMS'"));
	КонецЕсли;
	СписокОтборов.Добавить("ВходящиеПисьма", НСтр("ru='Входящие';uk='Вхідні'"));
	СписокОтборов.Добавить("ПисьмаЧерновики", НСтр("ru='Черновики';uk='Чернетки'"));
	СписокОтборов.Добавить("ИсходящиеПисьма", НСтр("ru='Исходящие';uk='Вихідні'"));
	СписокОтборов.Добавить("Отправленные", НСтр("ru='Отправленные';uk='Відправлені'"));
	СписокОтборов.Добавить("УдаленныеПисьма", НСтр("ru='Удаленные';uk='Вилучені'"));
	Если Не ТолькоПочта Тогда
		СписокОтборов.Добавить("ИсходящиеЗвонки", НСтр("ru='Исходящие звонки';uk='Вихідні дзвінки'"));
		СписокОтборов.Добавить("ВходящиеЗвонки", НСтр("ru='Входящие звонки';uk='Вхідні дзвінки'"));
	КонецЕсли;

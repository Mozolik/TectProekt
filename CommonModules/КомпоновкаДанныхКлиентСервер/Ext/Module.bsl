...
//
Функция ДобавитьОтбор(ЭлементСтруктуры, Знач Поле, Значение, ВидСравнения = Неопределено, Использование = Истина, ВПользовательскиеНастройки = Ложь, ЗаменятьСуществующий = Истина) Экспорт
	...
	Если ЗаменятьСуществующий Тогда

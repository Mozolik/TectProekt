...
Функция ИмяПрикладногоДокумента(ИмяДокумента) Экспорт
	...
	Если ИмяПрикладногоДокумента = Неопределено Тогда // не задано соответствие
		ШаблонСообщения = НСтр("ru='В коде прикладного решения необходимо указать соответствие для документа %1.';uk='У коді прикладного рішення необхідно зазначити відповідність документа %1.'");
...
Функция ИмяПрикладногоПВХ(ИмяПВХ) Экспорт
	...
	Если ИмяПрикладногоПВХ = Неопределено Тогда // не задано соответствие
		ШаблонСообщения = НСтр("ru='В коде прикладного решения необходимо указать соответствие для плана видов характеристик %1.';uk='У коді прикладного рішення необхідно зазначити відповідність плану для видів характеристик %1.'");
...
Функция ИмяПрикладнойФормы(ИмяФормы) Экспорт
	...
	Если ИмяПрикладнойФормы = Неопределено Тогда // не задано соответствие
		ШаблонСообщения = НСтр("ru='В коде прикладного решения необходимо указать соответствие для формы %1.';uk='У коді прикладного рішення необхідно зазначити відповідність форми для %1.'");
...
Функция ТекстовоеПредставлениеПодсистемыДляЖурналаРегистрации()
	...
	Возврат НСтр("ru='Обмен ЭД.';uk='Обмін ЕД.'");

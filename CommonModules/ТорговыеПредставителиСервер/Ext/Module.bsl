...
//
// Возвращаемое значение:
// Структура - Структура, включающая условия обслуживания
//
...
Функция ПолучитьДанныеУсловийОбслуживания(ПараметрыОтбора)
	...
	СтруктураВизита = ТорговыеПредставителиСервер.ПолучитьСтруктуруРеквизитовВизита(ТекущаяДата(), СтруктураДанных.ГрафикПосещения);

...
Функция ОтправитьSMS(НомераПолучателей, Знач Текст, ИмяОтправителя = "", ПеревестиВТранслит = Ложь) Экспорт
	...
	Если Не НастройкаОтправкиSMSВыполнена() Тогда
		Результат.ОписаниеОшибки = НСтр("ru='Неверно заданы настройки провайдера для отправки SMS.';uk='Невірно задані параметри провайдера для відправки SMS.'");
		Возврат Результат;
	КонецЕсли;
	...
	Если НастройкиОтправкиSMS.Провайдер = Перечисления.ПровайдерыSMS.TURBO Тогда // TURBOSMS
		Результат = ОтправкаSMSЧерезTURBO.ОтправитьSMS(НомераПолучателей, Текст, ИмяОтправителя,
		НастройкиОтправкиSMS.Логин, НастройкиОтправкиSMS.Пароль);
	ИначеЕсли НастройкиОтправкиSMS.Провайдер = Перечисления.ПровайдерыSMS.АльфаSMS Тогда // АльфаSMS
		Результат = ОтправкаSMSЧерезАльфаSMS.ОтправитьSMS(НомераПолучателей, Текст, ИмяОтправителя,
		НастройкиОтправкиSMS.Логин, НастройкиОтправкиSMS.Пароль);
...
Функция НастройкаОтправкиSMSВыполнена() Экспорт
	...
	Если Провайдер = Перечисления.ПровайдерыSMS.TURBO Тогда
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	ЗапросыРазрешений.Добавить(
		РаботаВБезопасномРежиме.ЗапросНаИспользованиеВнешнихРесурсов(ОтправкаSMSЧерезTURBO.Разрешения()));
	
	ЗапросыРазрешений.Добавить(
		РаботаВБезопасномРежиме.ЗапросНаИспользованиеВнешнихРесурсов(ОтправкаSMSЧерезАльфаSMS.Разрешения()));

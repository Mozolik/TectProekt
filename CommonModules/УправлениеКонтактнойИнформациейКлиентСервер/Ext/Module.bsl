...
Функция ТипыОбъектовАдресацииАдресаРФ() Экспорт
	...
	ЯзыкНаименования = Локализация.КодЯзыкаИнформационнойБазы();
	
	// Код, Наименование, Тип, Порядок, КодФИАС
	// Тип: 1 - владение, 2 - здание, 3 - помещение.
	
	Результат.Добавить(СтрокаОбъектаАдресации("1010", НСтр("ru='Дом';uk='Будинок'", ЯзыкНаименования),                1, 1, 2));
	Результат.Добавить(СтрокаОбъектаАдресации("1020", НСтр("ru='Владение';uk='Володіння'", ЯзыкНаименования),         1, 2, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("1030", НСтр("ru='Домовладение';uk='Домоволодіння'", ЯзыкНаименования), 1, 3, 3));
	
	Результат.Добавить(СтрокаОбъектаАдресации("1050", НСтр("ru='Корпус';uk='Корпус'", ЯзыкНаименования),      2, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("1060", НСтр("ru='Строение';uk='Будівля'", ЯзыкНаименования),   2, 2, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("1080", НСтр("ru='Литера';uk='Літера'", ЯзыкНаименования),      2, 3, 3));
	Результат.Добавить(СтрокаОбъектаАдресации("1070", НСтр("ru='Сооружение';uk='Споруда'", ЯзыкНаименования), 2, 4, 2));
	Результат.Добавить(СтрокаОбъектаАдресации("1040", НСтр("ru='Участок';uk='Ділянка'", ЯзыкНаименования),    2, 5));
	
	Результат.Добавить(СтрокаОбъектаАдресации("2010", НСтр("ru='Квартира';uk='Квартира'", ЯзыкНаименования),    3, 1));
	Результат.Добавить(СтрокаОбъектаАдресации("2030", НСтр("ru='Офис';uk='Офіс'", ЯзыкНаименования),            3, 2));
	Результат.Добавить(СтрокаОбъектаАдресации("2040", НСтр("ru='Бокс';uk='Бокс'", ЯзыкНаименования),            3, 3));
	Результат.Добавить(СтрокаОбъектаАдресации("2020", НСтр("ru='Помещение';uk='Приміщення'", ЯзыкНаименования), 3, 4));
	Результат.Добавить(СтрокаОбъектаАдресации("2050", НСтр("ru='Комната';uk='Кімната'", ЯзыкНаименования),      3, 5));
	Результат.Добавить(СтрокаОбъектаАдресации("2060", НСтр("ru='Этаж';uk='Поверх'", ЯзыкНаименования),        3, 6));
	//  Наши сокращения для поддержки обратной совместимости при парсинге.
	Результат.Добавить(СтрокаОбъектаАдресации("2010", НСтр("ru='кв.';uk='кв.'", ЯзыкНаименования),       3, 6));
	Результат.Добавить(СтрокаОбъектаАдресации("2030", НСтр("ru='оф.';uk='оф.'", ЯзыкНаименования),       3, 7));
...
Функция КодСериализацииПочтовогоИндекса() Экспорт
	...
	Возврат КодСериализацииОбъектаАдресации(НСтр("ru='Почтовый индекс';uk='Поштовий індекс'"));
...
Функция СокращенияОбъектовАдресацииАдресаРФ() Экспорт
	...
	Результат.Вставить(НСтр("ru='Дом';uk='Будинок'"), НСтр("ru='Д.';uk='Д.'"));
	Результат.Вставить(НСтр("ru='Владение';uk='Володіння'"), НСтр("ru='Вл.';uk='Вл.'"));
	Результат.Вставить(НСтр("ru='Домовладение';uk='Домоволодіння'"), НСтр("ru='Домовл.';uk='Домовл.'"));
	
	Результат.Вставить(НСтр("ru='Корпус';uk='Корпус'"), НСтр("ru='Корп.';uk='Корп.'"));
	Результат.Вставить(НСтр("ru='Строение';uk='Будівля'"), НСтр("ru='Стр.';uk='Стор.'"));
	Результат.Вставить(НСтр("ru='Литера';uk='Літера'"), НСтр("ru='Лит.';uk='Літ.'"));
	Результат.Вставить(НСтр("ru='Сооружение';uk='Споруда'"), НСтр("ru='Сооруж.';uk='Спорудах.'"));
	Результат.Вставить(НСтр("ru='Участок';uk='Ділянка'"), НСтр("ru='Уч.';uk='Обл.'"));
	
	Результат.Вставить(НСтр("ru='Квартира';uk='Квартира'"), НСтр("ru='Кв.';uk='Кв.'"));
	Результат.Вставить(НСтр("ru='Офис';uk='Офіс'"), НСтр("ru='Оф.';uk='Оф.'"));
	Результат.Вставить(НСтр("ru='Бокс';uk='Бокс'"), НСтр("ru='Бокс';uk='Бокс'"));
	Результат.Вставить(НСтр("ru='Помещение';uk='Приміщення'"), НСтр("ru='Пом.';uk='Пом.'"));
	Результат.Вставить(НСтр("ru='Комната';uk='Кімната'"), НСтр("ru='Ком.';uk='Ком.'"));
	Результат.Вставить(НСтр("ru='Этаж';uk='Поверх'"), НСтр("ru='Этаж';uk='Поверх'"));
...
Функция СтруктураЧастейАдресаНаселенногоПункта(ВариантКлассификатора = "ФИАС") Экспорт
	...
	Если ВариантКлассификатора = "КОАТУУ" Тогда
		Результат.Вставить("Регион",      ЭлементАдреснойСтруктуры(НСтр("ru='Область';uk='Область'"),     НСтр("ru='Область/город республиканского значения адреса';uk='Область/місто республіканського значення адреси'"),          "Область",     1));
	Иначе
	Результат.Вставить("Регион",           ЭлементАдреснойСтруктуры(НСтр("ru='Регион';uk='Регіон'"),      НСтр("ru='Регион адреса';uk='Регіон адреси'"),           "СубъектРФ",     1));
	КонецЕсли;
	Если ВариантКлассификатора = "ФИАС" Тогда
		Результат.Вставить("Округ",        ЭлементАдреснойСтруктуры(НСтр("ru='Округ';uk='Округ'"),       НСтр("ru='Округ адреса';uk='Округ адреси'"),            "Округ",         2));
	КонецЕсли;
	Результат.Вставить("Район",            ЭлементАдреснойСтруктуры(НСтр("ru='Район';uk='Район'"),       НСтр("ru='Район адреса';uk='Район адреси'"),            "СвРайМО/Район", 3));
	Результат.Вставить("Город",            ЭлементАдреснойСтруктуры(НСтр("ru='Город';uk='Місто'"),       НСтр("ru='Город адреса';uk='Місто адреси'"),            "Город",         4));
	Если ВариантКлассификатора = "ФИАС" Тогда
		Результат.Вставить("ВнутригРайон", ЭлементАдреснойСтруктуры(НСтр("ru='Внутр. р-н.';uk='Внутр. р-н.'"), НСтр("ru='Внутригородской район';uk='Внутрішньоміський район'"),   "ВнутригРайон",  5));
	КонецЕсли;
	Результат.Вставить("НаселенныйПункт", ЭлементАдреснойСтруктуры(НСтр("ru='Нас.пункт';uk='Нас.пункт'"),
		НСтр("ru='Населенный пункт адреса';uk='Населений пункт адреси'"), "НаселПункт",  6, Истина));
		
	Если ВариантКлассификатора <> "БезКлассификатора" Тогда
		Результат.Вставить("Улица", ЭлементАдреснойСтруктуры(НСтр("ru='Улица';uk='Вулиця'"),
			НСтр("ru='Улица адреса';uk='Вулиця адреси'"), "Улица", 7));
		Результат.Вставить("ДополнительныйЭлемент", ЭлементАдреснойСтруктуры(НСтр("ru='ДополнительныйЭлемент';uk='ДополнительныйЭлемент'"),
			НСтр("ru='Дополнительный элемент адреса';uk='Додатковий елемент адреси'"), "ДопАдрЭл[ТипАдрЭл='10200000']", 90));
		Результат.Вставить("ПодчиненныйЭлемент", ЭлементАдреснойСтруктуры(НСтр("ru='Подчиненный элемент';uk='Підпорядкований елемент'"),
			НСтр("ru='Подчиненный элемент адреса';uk='Підлеглий елемент адреси'"), "ДопАдрЭл[ТипАдрЭл='10400000']", 91));
	КонецЕсли;
...
Функция УстановитьЗначениеЧастиАдреса(ИмяЧастиАдреса, ЧастиАдреса, ВыбранноеЗначение) Экспорт
	...
	ЧастьАдреса.Наименование = ЧастьАдреса.Представление;
...
// Страны поддерживающие структурированный ввод
// 
// Возвращаемое значение:
//  Соответствие - Список стран
//
Функция ПолучитьСоответствиеСтранаКлассификатор() Экспорт
	СписокСтран = Новый Соответствие;
	СписокСтран.Вставить("БЕЛАРУСЬ", "КЛАДР");
	СписокСтран.Вставить("БІЛОРУСЬ", "КЛАДР");
	СписокСтран.Вставить("КАЗАХСТАН", "КЛАДР");
	СписокСтран.Вставить("КАЗАХСТАН", "КЛАДР");
	СписокСтран.Вставить("АРМЕНИЯ", "КЛАДР");
	СписокСтран.Вставить("ВІРМЕНІЯ", "КЛАДР");
	СписокСтран.Вставить("КИРГИЗИЯ", "КЛАДР");
	СписокСтран.Вставить("КИРҐИЗСТАН", "КЛАДР");
	СписокСтран.Вставить("РОССИЯ", "ФИАС");
	СписокСтран.Вставить("РОСІЙСЬКА ФЕДЕРАЦІЯ", "ФИАС");
	СписокСтран.Вставить("УКРАИНА", "КОАТУУ");
	СписокСтран.Вставить("УКРАЇНА", "КОАТУУ");
	Возврат СписокСтран;
КонецФункции

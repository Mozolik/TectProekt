...
// Возвращает пространтсто имен для пакето XDTO "InformationReferences"
//
// Возвращаемое значение:
...
// Возвращает пространтсто имен для пакето XDTO "InformationReferences_1_0_1_1"
//
// Возвращаемое значение:
//	Строка - пространство имен.
//
...
Функция ПолучитьИмяСобытияДляЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru='Информационный центр';uk='Інформаційний центр'",ТехнологияСервисаИнтеграцияСБСП.КодОсновногоЯзыка());
...
Функция ПолучитьПроксиЦентраИдей() Экспорт
	...
	ПроксиЦентраИдей = ТехнологияСервисаИнтеграцияСБСП.WSПрокси(АдресСервиса,
...
Функция ТекстВыводаИнформацииОбОшибкеВЦентреИдей() Экспорт 
	...
	Возврат НСтр("ru='Центр идей временно не доступен.
                       ...
                       |;uk='Центр ідей тимчасово не доступний.
...
//	ИдентифкаторПользователя - Строка - идентификатор пользователя.
//	ИдентификаторИдеи - Строка - идентификатор идеи.
//	Голос - Число - количество голосов.
//
Процедура ПроголосоватьЗаИдею(Знач WSПрокси, Знач ИдентифкаторПользователя, Знач ИдентификаторИдеи, Знач Голос) Экспорт
	
	WSПрокси.addVote(ИдентификаторИдеи, ИдентифкаторПользователя, Голос);
...
Функция СформироватьЗаголовокКомментариев(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru='Комментарии: %1';uk='Коментарі: %1'"), ПредставлениеИдеи.CommentsCount);
...
Функция СформироватьЗаголовокДатыРеализации(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru='Плановая дата реализации: %1';uk='Планова дата реалізації: %1'"), ПредставлениеИдеи.PlanMadeDatePresentation);
...
Функция СформироватьДатуОтклонения(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru='Отклонено: %1';uk='Відхилено: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
Функция СформироватьДатуРеализации(Знач ПредставлениеИдеи) Экспорт
	...
	Возврат СтрШаблон(НСтр("ru='Реализовано: %1';uk='Реалізовано: %1'"), Формат(ПредставлениеИдеи.ClosingDate, "ДЛФ=DD"));
...
//
// Параметры:
//	КоличетсвоГолосов- Число - количество голосов.
//	Плюс - Булево - признак плюса.
//
// Возвращаемое значение:
//	Строка - количество голосов.
//
Функция СформироватьКоличествоГолосов(Знач КоличетсвоГолосов, Знач Плюс = Истина) Экспорт
	
	
	Возврат ?(Плюс, "+", "-") + " ("+ КоличетсвоГолосов + ")";
...
Функция ПолучитьПроксиСлужбыПоддержки() Экспорт
	...
	ПроксиСлужбыПоддержки = ТехнологияСервисаИнтеграцияСБСП.WSПрокси(АдресСервиса,
...
Функция ТекстВыводаИнформацииОбОшибкеВСлужбеПоддержки() Экспорт
	...
	Возврат НСтр("ru='Служба поддержки временно не доступна.
                       |Пожалуйста, повторите попытку позже.'
                       |;uk='Служба підтримки тимчасово не доступна.
                       |Будь ласка, повторіть спробу пізніше.'")
...
//  МассивЭлементов - Массив - массив элеметнов формы.

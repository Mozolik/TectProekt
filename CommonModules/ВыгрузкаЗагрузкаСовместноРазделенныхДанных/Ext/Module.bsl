	...
	Если Не ОбъектНайденВКэше Тогда
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru='Объект метаданных %1 не может быть обработчиком ВыгрузкаСовместноРазделенныхДанных.ПередВыгрузкойОбъекта(),
                  ...
                  |ВыгрузкаЗагрузкаСовиестноРазделенныхДаннных.ЗаполнитьКэшСовместноРазделенныхОбъектов()'
                  |;uk='Об''єкт метаданих %1 не може бути обробником ВыгрузкаСовместноРазделенныхДанных.ПередВыгрузкойОбъекта(),
                  |так як відсутній у кеші сумісно-поділених об''єктів.
                  |Якщо після редагування структури метаданих конфігурації кеш не оновлювався - необхідно виконувати
                  |оновлення кешу сумісно-поділених об''єктів за допомогою виклику методу
                  |ВыгрузкаЗагрузкаСовиестноРазделенныхДаннных.ЗаполнитьКэшСовместноРазделенныхобъектов()'",Метаданные.ОсновнойЯзык.КодЯзыка),
	...
	Если Не ОбъектНайденВКэше Тогда
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru='Объект метаданных %1 не может быть обработчиком ВыгрузкаСовместноРазделенныхДанных.ПередЗагрузкойОбъекта(),
                  ...
                  |обновление кэша совместно-разделенных объектов с помощью вызова метода
                  |ВыгрузкаЗагрузкаСовиестноРазделенныхДаннных.ЗаполнитьКэшСовместноРазделенныхОбъектов()'
                  |;uk='Об''єкт метаданих %1 не може бути обробником ВыгрузкаСовместноРазделенныхДанных.ПередЗагрузкойОбъекта(),
                  |т. я. відсутній в кеші сумісно-розділених об''єктів.
                  |Якщо після редагування структури метаданих конфігурації кеш не оновлювався - необхідно виконувати
                  |оновлення кешу спільно-розподілених об''єктів за допомогою виклику методу
                  |ВыгрузкаЗагрузкаСовиестноРазделенныхданнных.ЗаполнитьКэшСовместноРазделенныхобъектов()'",Метаданные.ОсновнойЯзык.КодЯзыка),
			Объект.Метаданные().ПолноеИмя()
		);

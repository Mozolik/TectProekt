...
Процедура ВыбратьПолучателя(ОбработчикРезультата, Объект, МножественныйВыбор, ВозвращатьСоответствие) Экспорт
	...
	Если МножественныйВыбор Тогда
		ВозможныеПолучатели.Добавить(Неопределено, НСтр("ru='Всем получателям';uk='Всім одержувачам'"));
	КонецЕсли;
	...
	Иначе
		ВозможныеПолучатели.ПоказатьВыборЭлемента(Обработчик, НСтр("ru='Выбор получателя';uk='Вибір одержувача'"));
	КонецЕсли;
КонецПроцедуры
...
Процедура ПроверитьВыполнениеФоновогоЗадания(Форма) Экспорт
	...
	ИначеЕсли Результат.Статус = "Исключение" Тогда
		ПоказатьПредупреждение(, 
            ...
            |;uk='Розсилки не виконані через помилку,

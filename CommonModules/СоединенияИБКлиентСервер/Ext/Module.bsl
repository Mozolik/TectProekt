...
Функция ТекстДляАдминистратора() Экспорт
	...
	Возврат НСтр("ru='Для администратора:';uk='Для адміністратора:'");
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ru='Завершение работы пользователей';uk='Завершення роботи користувачів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());

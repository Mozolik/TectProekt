...
Функция ЭтоРазделительСлов(КодСимвола, РазделителиСлов = Неопределено) Экспорт
	...
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1169, 1169)); 	// символ "ґ"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1168, 1168)); 	// символ "Ґ"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1108, 1108)); 	// символ "є"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1028, 1028)); 	// символ "Є"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1110, 1110)); 	// символ "і"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1030, 1030)); 	// символ "І"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1111, 1111)); 	// символ "ї"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1031, 1031)); 	// символ "Ї"
...
Функция ТолькоКириллицаВСтроке(Знач СтрокаПроверки, Знач УчитыватьРазделителиСлов = Истина, ДопустимыеСимволы = "") Экспорт
	...
	КодыДопустимыхСимволов.Добавить(1169); // "ґ"
	КодыДопустимыхСимволов.Добавить(1168); // "Ґ"

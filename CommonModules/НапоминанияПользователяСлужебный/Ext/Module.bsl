...
Функция ПолучитьСтандартныеРасписанияДляНапоминания() Экспорт
	...
	Результат.Вставить(НСтр("ru='по понедельникам, в 9:00';uk='по понеділках, в 9:00'"), Расписание);
	...
	Расписание.ДниНедели = ДниНедели;
	Результат.Вставить(НСтр("ru='по пятницам, в 15:00';uk='по п''ятницях, в 15:00'"), Расписание);

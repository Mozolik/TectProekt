...
Функция ШаблонТемы() Экспорт
	Возврат НСтр("ru='[НаименованиеРассылки] от [ДатаВыполнения(ДЛФ=''D'')]';uk='[НаименованиеРассылки] від [ДатаВыполнения(ДЛФ=''D'')]'");
КонецФункции
...
Функция ШаблонИмениАрхива() Экспорт
	...
	Возврат НСтр("ru='[НаименованиеРассылки]_[ДатаВыполнения(ДФ=''yyyy-MM-dd'')]';uk='[НаименованиеРассылки]_[ДатаВыполнения(ДФ=''yyyy-MM-dd'')]'");
КонецФункции
...
Функция СписокВариантовЗаполненияРасписаний() Экспорт
	...
	СписокВариантов.Добавить(1, НСтр("ru='Каждый день';uk='Щодня'"));
	СписокВариантов.Добавить(2, НСтр("ru='Каждый второй день';uk='Кожний другий день'"));
	СписокВариантов.Добавить(3, НСтр("ru='Каждый четвертый день';uk='Кожний четвертий день'"));
	СписокВариантов.Добавить(4, НСтр("ru='По будням';uk='По будню'"));
	СписокВариантов.Добавить(5, НСтр("ru='По выходным';uk='По вихідним'"));
	СписокВариантов.Добавить(6, НСтр("ru='По понедельникам';uk='По понеділках'"));
	СписокВариантов.Добавить(7, НСтр("ru='По пятницам';uk='По п''ятницях'"));
	СписокВариантов.Добавить(8, НСтр("ru='По воскресеньям';uk='По неділях'"));
	СписокВариантов.Добавить(9, НСтр("ru='В первый день месяца';uk='У перший день місяця'"));
	СписокВариантов.Добавить(10, НСтр("ru='В последний день месяца';uk='В останній день місяця'"));
	СписокВариантов.Добавить(11, НСтр("ru='Каждый квартал десятого числа';uk='Кожний квартал десятого числа'"));
	СписокВариантов.Добавить(12, НСтр("ru='Другое...';uk='Інше...'"));
...
Функция СтрокаСообщенийПользователю(МассивОшибок = Неопределено, ДобавитьДежурнуюФразу = Истина) Экспорт
	...
	Если ВсеОшибки <> "" И ДобавитьДежурнуюФразу Тогда
		ВсеОшибки = ВсеОшибки + Отступ + "---" + Отступ + НСтр("ru='Подробности см. в журнале регистрации.';uk='Подробиці див. у журналі реєстрації.'");
	КонецЕсли;

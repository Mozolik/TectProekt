...
Функция ОтборПриВыбореСвязанногоОбъекта(СвязываемыйОбъект, ТипОбъектаДокументооборота) Экспорт
	...
	Если ТипЗнч(СвязываемыйОбъект) = Тип("СправочникСсылка.Контрагенты")
		...
		ЗначенияРеквизитов = ОбщегоНазначенияУТВызовСервера.ЗначенияРеквизитовОбъекта(
			СвязываемыйОбъект, "Наименование, КодПоЕДРПОУ");
		Если ЗначениеЗаполнено(ЗначенияРеквизитов.КодПоЕДРПОУ) Тогда
			Отбор = Новый Структура;
			Отбор.Вставить("okpo", ЗначенияРеквизитов.КодПоЕДРПОУ);
			Возврат Отбор;

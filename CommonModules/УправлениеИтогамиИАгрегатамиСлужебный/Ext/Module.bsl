...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Прототип.Представление = НСтр("ru='Оптимизировать программу';uk='Оптимізувати програму'");
	Прототип.Подсказка     = НСтр("ru='Ускорить проведение документов и формирование отчетов.
        ...
        |;uk='Прискорити проведення документів і формування звітів.
        |Обов''язкова щомісячна процедура може зайняти деякий час.'");
...
Функция РасписаниеЗаданияПоУмолчанию(Знач Имя)
	...
	Иначе
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Неизвестное имя задания %1';uk='Невідоме ім''я завдання %1'"), Имя);

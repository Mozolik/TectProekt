...
Функция СреднесписочнаяЧисленностьРаботающих(Организация, НачалоПериода, КонецПериода) Экспорт 
	...
	ДанныеЧисленности = Новый Структура("ЧисленностьРаботников, ЧисленностьЖенщин, ЧисленностьИнвалидов, ЧисленностьВнешнихСовместителей, ЧисленностьЧисленностьРаботниковГПХ, ЧисленностьЛицСГарантиями", 0, 0, 0, 0, 0, 0);

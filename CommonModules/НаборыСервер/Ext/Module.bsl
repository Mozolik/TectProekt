...
// Возвращает пустные значения параметров
// 
// Параметры:
//  Нет
//
...
Функция ПолучитьПрефиксИПостфикс(СтрокаТовары, ИспользоватьНаборы, КодЯзыка = "ru") Экспорт		
	...
	Если ИспользоватьНаборы 
		...
		Если НЕ ПолныйНабор Тогда
			Постфикс = Постфикс + " " + НСтр("ru='(Часть набора)';uk='(Частина набору)'", КодЯзыка);
		КонецЕсли;

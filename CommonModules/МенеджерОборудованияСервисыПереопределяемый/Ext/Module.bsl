...
Процедура ЗаполнитьНастройкиУстройства(ИДУстройства, Настройки) Экспорт
	...
	//  ! ПодключаемоеОборудованиеДемоВызовСервера.ЗаполнитьНастройкиУстройства(ИДУстройства, Настройки);
...
Процедура ЗаполнитьПрайсЛист(ИДУстройства, СтруктураПрайсЛиста) Экспорт
	...
	//! ПодключаемоеОборудованиеДемоВызовСервера.ЗаполнитьПрайсЛист(ИДУстройства, СтруктураПрайсЛиста);
...
Процедура ЗагрузитьДокумент(ИДУстройства, СтруктураОтвета, Документы) Экспорт
	...
	//! ПодключаемоеОборудованиеДемоВызовСервера.ЗагрузитьДокумент(ИДУстройства, СтруктураОтвета, Документы);
...
Процедура ЗаполнитьТипыДокументов(МассивТипов) Экспорт
	...
	//! ПодключаемоеОборудованиеДемоВызовСервера.ЗаполнитьТипыДокументов(МассивТипов);

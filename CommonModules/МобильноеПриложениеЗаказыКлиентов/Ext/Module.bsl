...
Функция ВыгрузитьЗадания(ИдентификаторМобильногоУстройства) Экспорт
	...
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка заданий';uk='Відправка завдань'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
...
Функция ВыгрузитьКлиентов(ИдентификаторМобильногоУстройства, ВсеКлиенты, УникальныйИдентификатор, АдресДанных) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка клиентов';uk='Відправка клієнтів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
...
Функция ВыгрузитьНастройки(ИдентификаторМобильногоУстройства) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка настроек';uk='Відправка настройок'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
...
Функция ВыгрузитьОстатки(ИдентификаторМобильногоУстройства, АдресДанных) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка остатков на складах';uk='Відправка залишків на складах'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
...
Функция ВыгрузитьПрайсЛист(ИдентификаторМобильногоУстройства, ВсеЦены = Ложь, АдресДанных) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка цен';uk='Відправка цін'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
...
Функция ВыгрузитьСправочники(ИдентификаторМобильногоУстройства) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка основных справочников';uk='Відправка основних довідників'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
...
Функция ВыгрузитьСтатусыЗаказыКлиентов(ИдентификаторМобильногоУстройства, СообщениеОбмена) Экспорт
	...
	СтруктураОтвета.Вставить("ДействиеПриОбмене", Перечисления.ДействияПриОбмене.ВыгрузкаДанных);
	СтруктураОтвета.Вставить("ДатаНачала", ТекущаяДатаСеанса());
	СтруктураОтвета.Вставить("Комментарий", НСтр("ru='Отправка состояния заказов клиентов';uk='Відправка стану замовлень клієнтів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
...
Функция ВыгрузитьСтатусыДокументов(ИдентификаторМобильногоУстройства, СообщениеОбмена, ТипДокумента) Экспорт
	...
	Если ТипДокумента = 0 Тогда
		КомментарийКОбмену = НСтр("ru='Отправка состояния заказов клиентов';uk='Відправка стану замовлень клієнтів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	ИначеЕсли ТипДокумента = 1 Тогда
		КомментарийКОбмену = НСтр("ru='Отправка состояния заявок на возврат';uk='Відправка стану заявок на повернення'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	КонецЕсли;

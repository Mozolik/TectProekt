...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не АвтономнаяРаботаСлужебный.ЭтоАвтономноеРабочееМесто() Тогда
		ВызватьИсключение НСтр("ru='Эта информационная база не является автономным рабочим местом.';uk='Ця інформаційна база не є автономним робочим місцем.'");
	КонецЕсли;
...
Процедура ОбновитьВидимостьНаСервере()
	...
	Если РольДоступнаНастройкаСинхронизацииДанных Тогда
		Элементы.ПоясняющаяНадписьПолученоОбновление.Заголовок = НСтр("ru='Получено обновление программы из Интернета.
            ...
            |;uk='Отримано оновлення програми з Інтернету.
            |Необхідно встановити отримане оновлення, після чого синхронізація буде продовжена.'");
	Иначе
		Элементы.ПоясняющаяНадписьПолученоОбновление.Заголовок = НСтр("ru='Получено обновление программы из Интернета.
            |Обратитесь к администратору информационной базы для установки полученного обновления.'
            |;uk='Отримано оновлення програми з Інтернету.
            |Зверніться до адміністратора інформаційної бази для встановлення отриманого оновлення.'");
	КонецЕсли;
...
Процедура ПриИзмененииРасписанияСинхронизацииДанных()
	...
	Элементы.ВариантРасписанияСинхронизацииДанных.СписокВыбора.Добавить(1, НСтр("ru='Каждые 15 минут';uk='Кожні 15 хвилин'"));
	Элементы.ВариантРасписанияСинхронизацииДанных.СписокВыбора.Добавить(2, НСтр("ru='Каждый час';uk='Щогодини'"));
	Элементы.ВариантРасписанияСинхронизацииДанных.СписокВыбора.Добавить(3, НСтр("ru='Каждый день в 10:00, кроме сб. и вс.';uk='Кожен день о 10:00, крім сб. та нд.'"));

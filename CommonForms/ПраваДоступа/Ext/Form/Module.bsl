...
Процедура ИсключитьИзГруппы(Команда)
	...
	Если НЕ ЗначениеЗаполнено(ТекущаяГруппаДоступа) Тогда
		ПоказатьПредупреждение(, НСтр("ru='Группа доступа не выбрана.';uk='Група доступу не обрана.'"));
		Возврат;
	КонецЕсли;
	...
	Иначе
		ПоказатьПредупреждение(,
			НСтр("ru='Недостаточно прав для редактирования группы доступа.
                       ...
                       |;uk='Недостатньо прав для редагування групи доступу.
                       |Редагувати групу доступу можуть відповідальний за учасників групи доступу та адміністратор.'"));
		Возврат;
	КонецЕсли;
		...
		Если Добавить Тогда
			ОписаниеОшибки =
				НСтр("ru='Невозможно включить пользователя в группу доступа,
                           ...
                           |;uk='Неможливо включити користувача в групу доступу,
                           |так як поточний користувач
                           |не відповідальний за учасників групи доступу і
                           |не повноправний адміністратор.'");
		Иначе
			ОписаниеОшибки =
				НСтр("ru='Невозможно исключить пользователя из группы доступа,
                           ...
                           |не ответственный за участников группы доступа и
                           |не полноправный администратор.'
                           |;uk='Неможливо виключити користувача з групи доступу,
                           |так як поточний користувач
                           |не відповідальний за учасників групи доступу і
                           |не повноправний адміністратор.'");
		КонецЕсли;
	...
	Если НЕ Добавить И НЕ ПользовательВключенВГруппуДоступа(ТекущаяГруппаДоступа) Тогда
		ОписаниеОшибки =
			НСтр("ru='Невозможно исключить пользователя из группы доступа,
                       ...
                       |;uk='Неможливо виключити користувача із групи доступу,
                       |тому що він включений у неї побічно.'");
		Возврат;
	КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru='Отправка SMS на телефон';uk='Відправка SMS на телефон'") + " " + НомераПолучателей;
КонецПроцедуры
...
Процедура Отправить(Команда)
	...
	Иначе
		...
		СтатусОтправки = НСтр("ru='Сообщение не было отправлено (см. журнал регистрации).';uk='Повідомлення було відправлено (див. журнал реєстрації).'");
...
Процедура ОшибкаОтправкиСообщения()
	ОписаниеОшибки = НСтр("ru='При попытке передать сообщение для отправки провайдеру SMS услуг возникла ошибка.';uk='При спробі передати повідомлення для відправки провайдера SMS послуг виникла помилка.'");
	ИмяСобытия = НСтр("ru='Ошибка отправки SMS отсутствует идентификатор сообщения.';uk='Помилка відправки SMS відсутній ідентифікатор повідомлення.'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
...
Функция СтатусДоставки(ИдентификаторСообщения)
	...
	СтатусыДоставки.Вставить("НеОтправлялось", НСтр("ru='Сообщение не отправлялось.';uk='Повідомлення не відправлялося.'"));
	СтатусыДоставки.Вставить("Отправляется", НСтр("ru='Отправка сообщения...';uk='Відправка повідомлення...'"));
	СтатусыДоставки.Вставить("Отправлено", НСтр("ru='Отправлено, ожидается подтверждение о доставке...';uk='Відправлено, очікується підтвердження про доставку...'"));
	СтатусыДоставки.Вставить("НеОтправлено", НСтр("ru='Сообщение не отправлено';uk='Повідомлення відправлено'"));
	СтатусыДоставки.Вставить("Доставлено", НСтр("ru='Сообщение доставлено';uk='Повідомлення доставлене'"));
	СтатусыДоставки.Вставить("НеДоставлено", НСтр("ru='Не доставлено';uk='Не доставлено'"));

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимРаботы = Перечисления.РежимыИспользованияИнформационнойБазы.Демонстрационный Тогда
		ВызватьИсключение(НСтр("ru='В демонстрационном режиме не доступно добавление новых пользователей';uk='У демонстраційному режимі не доступне додавання нових користувачів'"));
	КонецЕсли;

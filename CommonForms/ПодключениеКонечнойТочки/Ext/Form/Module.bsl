...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	ТекстПредупреждения = НСтр("ru='Отменить подключение конечной точки?';uk='Скасувати підключення кінцевої точки?'");
...
Процедура ПодключитьИЗакрыть(Результат = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Состояние(НСтр("ru='Выполняется подключение конечной точки. Пожалуйста, подождите...';uk='Виконується підключення кінцевої точки. Будь ласка, зачекайте...'"));
	...
	Если Отказ Тогда
        ...
        |;uk='При підключенні кінцевої точки виникли помилки.
	...
	ПоказатьОповещениеПользователя(,,НСтр("ru='Подключение конечной точки успешно завершено.';uk='Підключення кінцевої точки успішно завершено.'"));

...
Процедура ОбновитьДеревоСтруктурыПодчиненности()
	...
	Иначе
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Документ, для которого сформирован отчет о структуре подчиненности, стал недоступен.';uk='Документ, для якого сформований звіт про структуру підпорядкованості, став недоступним.'"));
	КонецЕсли;

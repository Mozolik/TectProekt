...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		СопровождающийТекст = НСтр("ru='Команда выполняется...';uk='Команда виконується...'");
	КонецЕсли;
	...
	Иначе
		Заголовок = НСтр("ru='Пожалуйста, подождите';uk='Будь ласка, почекайте'");
	КонецЕсли;
	...
	Попытка
		...
		ЗаданиеРезультат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Выполнение дополнительного отчета или обработки ""%1"", имя команды ""%2""';uk='Виконання додаткового звіту або обробки ""%1"", ім''я команди ""%2""'"),
...
Процедура Отменить(Команда)
	ТекстВопроса = НСтр("ru='Длительная операция еще выполняется.';uk='Тривала операція ще виконується.'");

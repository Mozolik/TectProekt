...
Процедура ИзменитьВидимостьДеревоРазделов()
	...
	Элементы.СкрытьПоказатьДеревоРазделов.Заголовок = ?(Элементы.ГруппаДеревоРазделов.Видимость,НСтр("ru='Скрыть разделы';uk='Приховати розділи'"), НСтр("ru='Показать разделы';uk='Показати розділи'"));

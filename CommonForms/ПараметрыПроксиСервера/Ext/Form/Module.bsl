...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.НастройкаПроксиНаКлиенте
		...
		ВызватьИсключение НСтр("ru='Недостаточно прав доступа.
            ...
            |
            |Настройка проксі-сервера виконується адміністратором.'");
	КонецЕсли;
	...
	Иначе
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ru='Параметры прокси-сервера на сервере платформы';uk='Параметри проксі-сервера на сервері платформи'");

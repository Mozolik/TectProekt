...
Функция ПроверитьЗаполнениеРеквизитов(МассивОшибок)
	...
	Если Не ЗначениеЗаполнено(Тип) Тогда
		ТекстОшибки = НСтр("ru='Не заполнен реквизит Тип поля.';uk='Не заповнено реквізит Тип поля.'");
		МассивОшибок.Добавить(ТекстОшибки);
	КонецЕсли;
	
	// Проверка типа заполнения.
	Если Не ЗначениеЗаполнено(ТипЗаполнения) Тогда
		ТекстОшибки = НСтр("ru='Не заполнен реквизит Тип заполнения.';uk='Не заповнено реквізит Тип заповнення.'");
		МассивОшибок.Добавить(ТекстОшибки);
	КонецЕсли;
	
	// Проверка значения.
	Если Не ЗначениеЗаполнено(Значение) И ТипЗаполнения = "Parameter" Тогда
		ТекстОшибки = НСтр("ru='Не заполнен реквизит Значение.';uk='Не заповнено реквізит Значення.'");
		МассивОшибок.Добавить(ТекстОшибки);
	КонецЕсли;
	...
	Если Тип <> "UserData" Тогда
		...
		Если Лево>Право Тогда
			ТекстОшибки = НСтр("ru='Левая координата не может быть больше правой.';uk='Ліва координата не може бути більше правої.'");
			МассивОшибок.Добавить(ТекстОшибки);
		КонецЕсли;
		
		Если Верх>Низ Тогда
			ТекстОшибки = НСтр("ru='Верхней координата не может быть больше нижней.';uk='Верхя координата не може бути більше нижньої.'");
			МассивОшибок.Добавить(ТекстОшибки);
		КонецЕсли;
	...
	Если Тип = "Text" Тогда
		...
		Если Не ЗначениеЗаполнено(ПоложениеПоГоризонтали) Тогда
			ТекстОшибки = НСтр("ru='Не заполнен реквизит Горизонтальное положение.';uk='Не заповнено реквізит Горизонтальне положення.'");
			МассивОшибок.Добавить(ТекстОшибки);
		КонецЕсли;
		
		// Проверка ПоложениеПоВертикали.
		Если Не ЗначениеЗаполнено(ПоложениеПоВертикали) Тогда
			ТекстОшибки = НСтр("ru='Не заполнен реквизит Вертикальное положение.';uk='Не заповнено реквізит Вертикальне положення.'");
			МассивОшибок.Добавить(ТекстОшибки);
		КонецЕсли;
	...
	ИначеЕсли Тип = "Barcode" Тогда
		...
		Если Не ЗначениеЗаполнено(ТипШтрихкода) Тогда
			ТекстОшибки = НСтр("ru='Не заполнен реквизит Тип штрихкода.';uk='Не заповнено реквізит Тип штрихкоду.'");
			МассивОшибок.Добавить(ТекстОшибки);
		КонецЕсли;
		...
		Если ПодписьШтрихкода Тогда
			Если Не ЗначениеЗаполнено(РазмерШрифта) Тогда
				ТекстОшибки = НСтр("ru='Не заполнен реквизит Размер шрифта подписи.';uk='Не заповнено реквізит Розмір шрифту підпису.'");
				МассивОшибок.Добавить(ТекстОшибки);
			КонецЕсли;
		КонецЕсли;
	...
	Если Тип = "Text" ИЛИ Тип = "Image" Тогда
		...
		Если РамкаСверху ИЛИ РамкаСлева ИЛИ РамкаСнизу ИЛИ РамкаСправа Тогда
			...
			Если Не ЗначениеЗаполнено(ТипРамки) Тогда
				ТекстОшибки = НСтр("ru='Не заполнен реквизит Тип рамки.';uk='Не заповнено реквізит Тип рамки.'");
				МассивОшибок.Добавить(ТекстОшибки);
			КонецЕсли;
			
			// Проверка ТолщинаРамки.
			Если Не ЗначениеЗаполнено(ТолщинаРамки) Тогда
				ТекстОшибки = НСтр("ru='Не заполнен реквизит Толщина рамки.';uk='Не заповнено реквізит Товщина рамки.'");
				МассивОшибок.Добавить(ТекстОшибки);
			КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			// Режим подбора.
			Заголовок = НСтр("ru='Подбор групп внешних пользователей';uk='Підбір груп зовнішніх користувачів'");
			Элементы.Список.МножественныйВыбор = Истина;
			Элементы.Список.РежимВыделения = РежимВыделенияТаблицы.Множественный;
		Иначе
			Заголовок = НСтр("ru='Выбор группы внешних пользователей';uk='Вибір групи зовнішніх користувачів'");
		КонецЕсли;
	КонецЕсли;

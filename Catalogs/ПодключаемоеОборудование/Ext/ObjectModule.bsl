...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ПустаяСтрока(Наименование) Тогда
		...
		Если Не Запрос.Выполнить().Пустой() Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Указано неуникальное наименование элемента. Укажите уникальное наименование.';uk='Зазначено не унікальне найменування елементу. Вкажіть унікальне найменування.'"), ЭтотОбъект, , , Отказ);
		КонецЕсли;
	КонецЕсли;
	...
	Если ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.WebСервисОборудование Тогда
		...
		Если ЗначениеЗаполнено(ИдентификаторWebСервисОборудования) Тогда
			...
			Если Не Запрос.Выполнить().Пустой() Тогда
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Указан неуникальный идентификатор активного оборудования элемента. Укажите уникальный идентификатор.';uk='Вказаний неунікальний ідентифікатор активного обладнання елемента. Вкажіть унікальний ідентифікатор.'"), ЭтотОбъект, , , Отказ);
			КонецЕсли;
		КонецЕсли;
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Наименование = НСтр("ru='%Наименование% (копия)';uk='%Наименование% (копія)'");

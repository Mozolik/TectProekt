...
Процедура ПроверитьВозможностьЗаписи(Отказ)
	...
	Если Выборка.Следующий() Тогда
		ТекстСообщения = НСтр("ru='Мобильный компьютер с указанным серийным номером уже имеется в справочнике';uk='Мобільний комп''ютер з зазначеним серійним номером вже є в довіднику'");

...
Процедура ПриОткрытии(Отказ)
	...
	Если ЭтаФорма.ТаблицаНовостей.Количество() <= 0 Тогда
		...
		ТекстСообщения     = НСтр("ru='Для этой формы нет контекстных новостей.';uk='Для цієї форми немає контекстних новин.'");
		ПояснениеСообщения = НСтр("ru='Нажмите здесь для просмотра всех новостей.';uk='Натисніть тут для перегляду новин.'");

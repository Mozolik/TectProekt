...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтаФорма.ВремяПереносаПоказатьПозжеМинут > 0 Тогда
		Если ЭтаФорма.ТаблицаНовостей.Количество() = 1 Тогда
			ТекстПодсказки = НСтр("ru='Не напоминать про эту новость %ВремяПереносаПоказатьПозжеМинут% минут';uk='Не нагадувати про цю новину %ВремяПереносаПоказатьПозжеМинут% хвилин'");
		Иначе
			ТекстПодсказки = НСтр("ru='Не напоминать про эти новости %ВремяПереносаПоказатьПозжеМинут% минут';uk='Не нагадувати про ці новини %ВремяПереносаПоказатьПозжеМинут% хвилин'");
		КонецЕсли;

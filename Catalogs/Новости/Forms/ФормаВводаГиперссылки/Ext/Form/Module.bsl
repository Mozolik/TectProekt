...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ПустаяСтрока(ЭтаФорма.Действие) Тогда
		...
		Сообщение.Текст = НСтр("ru='Не заполнено поле Действие';uk='Не заповнено поле Дія'");
	...
	Если ПустаяСтрока(ЭтаФорма.УИНДействия) Тогда
		Отказ = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Не заполнен идентификатор гиперссылки (должен заполниться автоматически после выбора Действия)';uk='Не заповнений ідентифікатор гіперпосилання (повинен заповнюватися автоматично після вибору Дії)'");
	...
	Если ЭтаФорма.Действие = "Переход по навигационной ссылке" Тогда
		Если ПустаяСтрока(ЭтаФорма.ПараметрДействия_НавигационнаяСсылка) Тогда
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Не заполнена навигационная ссылка';uk='Не заповнена навігаційна посилання'");
	...
	ИначеЕсли ЭтаФорма.Действие = "Открытие раздела справки" Тогда
		Если ПустаяСтрока(ЭтаФорма.ПараметрДействия_РазделСправки) Тогда
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Не заполнен раздел справки';uk='Не заповнений розділ довідки'");
	...
	ИначеЕсли ЭтаФорма.Действие = "Переход по интернет ссылке" Тогда
		Если ПустаяСтрока(ЭтаФорма.ПараметрДействия_ИнтернетСсылка) Тогда
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Не заполнена интернет-ссылка';uk='Не заповнена інтернет-посилання'");
	...
	ИначеЕсли ЭтаФорма.Действие = "Показать картинку" Тогда
		Если ПустаяСтрока(ЭтаФорма.КартинкаЗаголовок) Тогда
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Не заполнен заголовок картинки';uk='Не заповнений заголовок картинки'");
		...
		Если ПустаяСтрока(ЭтаФорма.КартинкаДанные) Тогда
			Отказ = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ru='Не загружена картинка. Нажмите <Выбрать картинку из файла>';uk='Не завантажена картинка. Натисніть <Вибрати картинку з файлу>'");
			Сообщение.Поле  = "КартинкаЗаголовок";
			Сообщение.Сообщить();
		КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// ////? При переходе на 2.1.8 удалить этот код, т.к. он более не используется в БСП.
	// При обновлении версии конфигурации может быть вызвана ошибка.
	// Чтобы ошибки не было, необходимо выполнить следующий стандартный код БСП.

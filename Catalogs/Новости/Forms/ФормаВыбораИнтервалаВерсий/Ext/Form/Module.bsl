...
Процедура ВерсияПриИзменении(Элемент)
	...
	ЭтаФорма.Версия = ОбработкаНовостейКлиентСервер.ПривестиСтрокуКПравильномуФорматуВерсии(ЭтаФорма.Версия);
...
Процедура ВерсияОТПриИзменении(Элемент)
	...
	ЭтаФорма.ВерсияОТ = ОбработкаНовостейКлиентСервер.ПривестиСтрокуКПравильномуФорматуВерсии(ЭтаФорма.ВерсияОТ);
	ЭтаФорма.Версия = ЭтаФорма.ВерсияОТ;
...
Процедура ВерсияДОПриИзменении(Элемент)
	...
	ЭтаФорма.ВерсияДО = ОбработкаНовостейКлиентСервер.ПривестиСтрокуКПравильномуФорматуВерсии(ЭтаФорма.ВерсияДО);

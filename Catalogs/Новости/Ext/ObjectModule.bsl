...
Процедура ПередЗаписью(Отказ)
	...
	ИначеЕсли (СокрЛП(ВРег(ЭтотОбъект.УИННовости)) = ВРег("313f4928-a71c-4cef-96ee-a4b6106c1275"))
		...
		ТекстСообщения = НСтр("ru='Перед записью новости про системную ошибку у нее было установлено свойство СкрыватьВОбщемСпискеНовостей, чтобы она не отображалась пользователю.
            ...
            |;uk='Перед записом новини про системну помилку у неї було встановлено властивість СкрыватьВОбщемСпискеНовостей, щоб вона не відображалася користувачеві.
            |Дані новини:
            |УІН: %УИННовости%
            |Текст новости: %ТекстНовости%'");
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru='Новости. Изменение данных. Новость. Перед записью';uk='Новини. Зміна даних. Новина. Перед записом'"), // ИдентификаторШага

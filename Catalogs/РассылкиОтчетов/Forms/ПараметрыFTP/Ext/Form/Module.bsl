...
Процедура Заполнить(Команда)
	Если Сервер = "" Тогда
		ПолныйАдрес = НСтр("ru='ftp://логин:пароль@сервер:порт/каталог/';uk='ftp://логін:пароль@сервер:порт/каталог/'");
	Иначе
		Если Логин = "" Тогда
	...
	ПоказатьВводСтроки(Обработчик, ПолныйАдрес, НСтр("ru='Введите полный ftp адрес';uk='Введіть повну ftp адресу'"))
КонецПроцедуры
...
&НаКлиенте
Функция ПарольСкрыт()
	Возврат НСтр("ru='<пароль скрыт>';uk='<пароль прихований>'");
КонецФункции

	...
	Если ВидФормы = "ФормаОбъекта" Тогда
		...
		ИначеЕсли ПараметрыОткрытия.ТипОтчета = "Дополнительный" Тогда
			...
			Если Не ПараметрыОткрытия.Подключен Тогда
				ВызватьИсключение НСтр("ru='Вариант внешнего отчета можно открыть только из формы отчета.';uk='Варіант зовнішнього звіту можна відкрити тільки з форми звіту.'");
			КонецЕсли;
		Иначе
			ВызватьИсключение НСтр("ru='Вариант внешнего отчета можно открыть только из формы отчета.';uk='Варіант зовнішнього звіту можна відкрити тільки з форми звіту.'");
		КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЕстьПользовательскиеНастройки(Параметры.МассивВариантов) Тогда
		ТекстОшибки = НСтр("ru='Пользовательские настройки выбранных вариантов отчетов (%1 шт) не заданы или уже сброшены.';uk='Користувацькі настройки обраних варіантів звітів (%1 шт) не задані або вже скинуті.'");
...
Процедура КомандаСбросить(Команда)
	...
	Если КоличествоВариантов = 1 Тогда
		...
		ОповещениеЗаголовок = НСтр("ru='Сброшены пользовательские настройки варианта отчета';uk='Скинуто користувацькі настройки варіанта звіту'");
	...
	Иначе
        ...
        |;uk='Скинуто користувацькі настройки

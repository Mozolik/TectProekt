...
Процедура ОформитьНаборыИСвойства()
	...
	ЭлементЦветаОформления.Значение = НСтр("ru='Наборы';uk='Набори'");
...
Процедура НастроитьОтображениеНаборов()
	...
	Если ЭтоНаборыДополнительныхСведений Тогда
		Заголовок = НСтр("ru='Дополнительные сведения';uk='Додаткові відомості'");
		
		КомандаСоздать.Подсказка          = НСтр("ru='Создать уникальное сведение';uk='Створити унікальна відомість'");
		КомандаСоздать.Заголовок          = НСтр("ru='Новое';uk='Нове'");
		КомандаСоздать.Подсказка          = НСтр("ru='Создать уникальное сведение';uk='Створити унікальна відомість'");
		
		КомандаСкопировать.Подсказка        = НСтр("ru='Создать новое сведение копированием текущего';uk='Створити нову відомість копіюванням поточної'");
		КомандаИзменить.Подсказка           = НСтр("ru='Изменить (или открыть) текущее сведение';uk='Змінити (або відкрити) поточну відомість'");
		КомандаПометитьНаУдаление.Подсказка = НСтр("ru='Пометить текущее сведение на удаление (Del)';uk='Відмітити поточну відомість для вилучення (Del)'");
		КомандаПереместитьВверх.Подсказка   = НСтр("ru='Переместить текущее сведение вверх';uk='Перемістити поточну відомість вверх'");
		КомандаПереместитьВниз.Подсказка    = НСтр("ru='Переместить текущее сведение вниз';uk='Перемістити поточну відомість униз'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ru='Типы значения, которое можно ввести при заполнении сведения.';uk='Типи значення, яке можна ввести при заповненні відомості.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ru='Сведение использует список значений сведения-образца.';uk='Відомість використовує список значень відомості-зразка.'");
		
		Элементы.СвойстваОбщее.Заголовок = НСтр("ru='Общее';uk='Загальне'");
		Элементы.СвойстваОбщее.Подсказка = НСтр("ru='Общее дополнительное сведение, которое используется в
                                                      ...
                                                      |;uk='Загальна додаткова відомість, що використовується в
                                                      |декількох наборах додаткових відомостей.'");
	Иначе
		Заголовок = НСтр("ru='Дополнительные реквизиты';uk='Додаткові реквізити'");
		КомандаСоздать.Заголовок          = НСтр("ru='Новый';uk='Новий'");
		КомандаСоздать.Подсказка          = НСтр("ru='Создать уникальный реквизит';uk='Створити унікальний реквізит'");
		
		КомандаСкопировать.Подсказка        = НСтр("ru='Создать новый реквизит копированием текущего';uk='Створити новий реквізит копіюванням поточного'");
		КомандаИзменить.Подсказка           = НСтр("ru='Изменить (или открыть) текущий реквизит';uk='Змінити (або відкрити) поточний реквізит'");
		КомандаПометитьНаУдаление.Подсказка = НСтр("ru='Пометить текущий реквизит на удаление (Del)';uk='Відмітити поточний реквізит для вилучення (Del)'");
		КомандаПереместитьВверх.Подсказка   = НСтр("ru='Переместить текущий реквизит вверх';uk='Перемістити поточний реквізит вверх'");
		КомандаПереместитьВниз.Подсказка    = НСтр("ru='Переместить текущий реквизит вниз';uk='Перемістити поточний реквізит униз'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ru='Типы значения, которое можно ввести при заполнении реквизита.';uk='Типи значення, яке можна ввести при заповненні реквізиту.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ru='Реквизит использует список значений реквизита-образца.';uk='Реквізит використовує список значень реквізиту-зразка.'");
		
		Элементы.СвойстваОбщее.Заголовок = НСтр("ru='Общий';uk='Загальний'");
		Элементы.СвойстваОбщее.Подсказка = НСтр("ru='Общий дополнительный реквизит, который используется в
                                                      ...
                                                      |;uk='Загальний додатковий реквізит, що використовується в
                                                      |декількох наборах додаткових реквізитів.'");
	КонецЕсли;
	...
	Если Элементы.Свойства.ТекущиеДанные <> Неопределено Тогда
		...
		Если ЭтоНаборыДополнительныхСведений Тогда
			Если Элементы.Свойства.ТекущиеДанные.Общее Тогда
				ТекстВопроса = НСтр("ru='Исключить текущее общее сведения из набора?';uk='Виключити поточну загальну відомість з набору?'");
				
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru='Снять с текущего сведения пометку на удаление?';uk='Зняти з поточної відомості позначку на вилучення?'");
			Иначе
				ТекстВопроса = НСтр("ru='Пометить текущее сведение на удаление?';uk='Відмітити поточну відомість для вилучення?'");
			КонецЕсли;
		Иначе
			Если Элементы.Свойства.ТекущиеДанные.Общее Тогда
				ТекстВопроса = НСтр("ru='Исключить текущий общий реквизит из набора?';uk='Виключити поточний загальний реквізит з набору?'");
				
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru='Снять с текущего реквизита пометку на удаление?';uk='Зняти з поточного реквізиту позначку на вилучення?'");
			Иначе
				ТекстВопроса = НСтр("ru='Пометить текущий реквизит на удаление?';uk='Відмітити поточний реквізит для вилучення?'");
			КонецЕсли;
		КонецЕсли;

...
Процедура ПередЗаписью(Отказ)
	...
	// Актуальность кеша необходимо сбрасыать если используется/использовался внешний отчет.
	// В противном случае, состояние кеша актуально.
	Если Не ЭтоГруппа Тогда
		КешСхемЗвит1САктуален = Ложь;
		КешСхемЗвит1С.Очистить();
	КонецЕсли;

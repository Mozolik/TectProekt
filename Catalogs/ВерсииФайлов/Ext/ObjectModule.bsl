...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ЭтоНовый() Тогда
		...
		Если ЗаписьПодписанногоОбъекта <> Истина Тогда
			...
			Если Зашифрован И СсылкаЗашифрован И ПодписанЭП И НЕ СсылкаПодписан Тогда
				ВызватьИсключение НСтр("ru='Зашифрованную версию файла нельзя подписывать.';uk='Зашифровану версію файлу не можна підписувати.'");
			КонецЕсли;
	...
	Если Владелец.ТекущаяВерсия = Ссылка Тогда
		Если ПометкаУдаления = Истина И Владелец.ПометкаУдаления <> Истина Тогда
			ВызватьИсключение НСтр("ru='Активную версию нельзя удалить.';uk='Активну версію не можна вилучити.'");
		КонецЕсли;
	ИначеЕсли РодительскаяВерсия.Пустая() Тогда
		Если ПометкаУдаления = Истина И Владелец.ПометкаУдаления <> Истина Тогда
			ВызватьИсключение НСтр("ru='Первую версию нельзя удалить.';uk='Першу версію не можна видалити.'");
		КонецЕсли;

...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// Для депозитов и займов выданных указываем доходные направления
	Если НЕ (ХарактерДоговора = ХарактерыДоговоров.КредитИлиЗайм 
			И ПолучитьФункциональнуюОпцию("ИспользоватьУчетЗатратПоНаправлениямДеятельности")
			И ЗначениеНастроекПовтИсп.УказыватьНаправлениеВЗатратах()
		ИЛИ ХарактерДоговора <> ХарактерыДоговоров.КредитИлиЗайм 
			И ПолучитьФункциональнуюОпцию("ИспользоватьУчетДоходовПоНаправлениямДеятельности")
			И ЗначениеНастроекПовтИсп.УказыватьНаправлениеВДоходах()
		) Тогда
...
Процедура ПроверитьВозможностьВводаНаОснованииПартнера(Партнер) Экспорт
	...
	Если Не ПрочиеОтношения Тогда
        ...
        |;uk='З партнером ""%Партнер%"" не дозволені інші відносини. 
        |Введення на підставі доступно тільки для партнерів з якими дозволені інші відносини.'");

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПустаяСтрока(Объект.ИмяШаблонаСКД) Тогда
		...
		Элементы.ИмяШаблонаСКД.СписокВыбора.Добавить("", НСтр("ru='Произвольная';uk='Довільна'"));
...
Процедура Редактировать(Команда)
	...
	ЗаголовокФормыНастройкиСхемыКомпоновкиДанных = НСтр("ru='Настройки источника данных планирования ""%ИмяИсточникаДанных%""';uk='Настройки джерела даних планування ""%ИмяИсточникаДанных%""'");
...
Процедура ИмяШаблонаСКДПриИзменении(Элемент)
	...
	Если НайденныеСтроки.Количество() = 0 Тогда
		...
		ТекстПредупреждения = НСтр("ru='Ошибка загрузки шаблона. Выберите другой шаблон.';uk='Помилка завантаження шаблону. Виберіть інший шаблон.'");
...
Процедура ПредупредитьОВыборкеДанных(РекомендуемаяВыборкаПоПериоду = Неопределено)
	...
	ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
									НСтр("ru='Схема компоновки данных, возможно, не поддерживает выборку данных ""%1"".';uk='Схема компонування даних, можливо, не підтримує вибірку даних ""%1"".'"),
	...
	ТекстПредупреждения = ТекстПредупреждения
							...
							+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
									НСтр("ru='Рекомендуется использовать: %1.';uk='Рекомендується використовувати: %1.'"), 
									РекомендуемыеВыборкиПоПериоду);

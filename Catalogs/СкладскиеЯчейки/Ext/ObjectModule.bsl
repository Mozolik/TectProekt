...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не СкладыСервер.ИспользоватьАдресноеХранение(Владелец, Помещение,,Ложь) Тогда
		...
		Если Не СкладыСервер.ИспользоватьАдресноеХранениеСправочно(Владелец, Помещение) Тогда
			...
			ТекстСообщения = НСтр("ru='По складу ""%Склад%"" не используется адресное хранение!';uk='По складу ""%Склад%"" не використовується адресне зберігання!'");
	...
	ИначеЕсли ЗначениеЗаполнено(Родитель) Тогда
		...
		Если РеквизитыРодителя.Помещение <> Помещение Тогда
			ТекстСообщения = НСтр("ru='В группе ""%Группа%"" все ячейки должны быть по помещению ""%Помещение%""';uk='У групі ""%Группа%"" всі комірки повинні бути з приміщення""%Помещение%""'");

...
Функция ОбработкаСправочниковСервер()
	...
	НаименованиеЗадания = НСтр("ru='Заполнение помещения в справочниках по складу ""%Склад"".';uk='Заповнення приміщення в довідниках по складу ""%Склад"".'");
...
Процедура СоздатьРезервнуюКопиюНажатие(Элемент)
	//Резервная копия ИБ
	ФормаОбр = ПолучитьФорму("Обработка.РезервноеКопированиеИБ.Форма");
	ФормаОбр.Открыть();
КонецПроцедуры 

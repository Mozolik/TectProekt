...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок =  СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Выбор реквизита %1';uk='Вибір реквізиту %1'"), ?(Объект.Синоним = "", Объект.Имя, Объект.Синоним));
...
Процедура ЗаполнитьДеревоРеквизитов(ИмяМетаданных)
	...
	НоваяСтрока.Представление = НСтр("ru='Представление';uk='Представлення'");
	НоваяСтрока.ПредставлениеПути = НСтр("ru='Представление';uk='Представлення'");
...
Процедура ЗаполнитьПодчиненныеРеквизиты(Строка, ИмяМетаданных)
	...
	НоваяСтрока.Представление = НСтр("ru='Представление';uk='Представлення'");
	НоваяСтрока.ПредставлениеПути = ДанныеСтроки.ПредставлениеПути + "." + НСтр("ru='Представление';uk='Представлення'");
	НоваяСтрока.Тип = "Строка";

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗаполненВШаблоне Тогда
		...
		СписокВариантов.Добавить(ИзШаблона, НСтр("ru='Из шаблона';uk='З шаблону'"));
		...
		Если Параметры.ШаблонЗапрещаетИзменение = Истина
			...
			Если ИмяРеквизитаОбъектаДокументооборота = "documentType" Тогда
				ИнформационнаяНадпись = 
					НСтр("ru='Вид документа выбран в шаблоне и не может быть изменен.';uk='Вид документа обраний в шаблоні і не може бути змінений.'");
			Иначе
				ИнформационнаяНадпись = 
					НСтр("ru='Шаблон запрещает изменение заданных в нем реквизитов.';uk='Шаблон забороняє зміну заданих у ньому реквізитів.'");
			КонецЕсли;

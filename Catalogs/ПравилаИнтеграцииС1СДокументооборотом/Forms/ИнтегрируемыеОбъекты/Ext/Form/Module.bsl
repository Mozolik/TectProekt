...
Процедура УстановитьДоступностьКоманд(ТекущиеДанные)
	...
	ИначеЕсли ТекущиеДанные.ЭтоГруппа Тогда
		...
		Если ТекущиеДанные.Автонастройка = Истина Тогда
			Подсказка = НСтр("ru='Объекты подсистемы поддерживают автоматическую настройку интеграции.';uk='Об''єкти підсистеми підтримують автоматичну настройку інтеграції.'");
		ИначеЕсли ТекущиеДанные.Автонастройка = Ложь Тогда
			Подсказка = НСтр("ru='Интеграция по объектам подсистемы настраивается вручную.';uk='Інтеграція по об''єктах підсистеми, яка настроюється вручну.'");
		Иначе
			Подсказка = НСтр("ru='Некоторые объекты подсистемы поддерживают автоматическую настройку интеграции.';uk='Деякі об''єкти підсистеми підтримують автоматичну настройку інтеграції.'");
		КонецЕсли;
...
Функция ОписаниеВыполняемыхДействийПоУмолчанию()
	...
	Возврат НСтр("ru='Будет автоматически создано правило интеграции.
        |В Документообороте будет создан соответствующий вид документа.'
        |;uk='Буде автоматично створено правило інтеграції.
        |У Документообігу буде створений відповідний вид документа.'");
...
Процедура НастроитьАвтоматически(ТекущиеДанные)
	...
	ТекстВопроса = ОписаниеВыполняемыхДействий
		...
		+ Символы.ПС
		+ НСтр("ru='Продолжить?';uk='Продовжити?'");

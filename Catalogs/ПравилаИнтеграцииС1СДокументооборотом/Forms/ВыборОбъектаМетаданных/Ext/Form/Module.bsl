...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьВеткуДереваМетаданных(Дерево, ИменаМетаданных, "Справочники", БиблиотекаКартинок.Справочник, НСтр("ru='Справочники';uk='Довідники'"));
	ЗаполнитьВеткуДереваМетаданных(Дерево, ИменаМетаданных, "Документы",   БиблиотекаКартинок.Документ, НСтр("ru='Документы';uk='Документи'"));
	ЗаполнитьВеткуДереваМетаданных(Дерево, ИменаМетаданных, "ПланыВидовРасчета",   БиблиотекаКартинок.ПланВидовРасчета, НСтр("ru='Планы видов расчета';uk='Плани видів розрахунку'"));
	ЗаполнитьВеткуДереваМетаданных(Дерево, ИменаМетаданных, "БизнесПроцессы", БиблиотекаКартинок.БизнесПроцесс, НСтр("ru='Бизнес-процессы';uk='Бізнес-процеси'"));
	ЗаполнитьВеткуДереваМетаданных(Дерево, ИменаМетаданных, "Задачи", БиблиотекаКартинок.Задача, НСтр("ru='Задачи';uk='Задачі'"));

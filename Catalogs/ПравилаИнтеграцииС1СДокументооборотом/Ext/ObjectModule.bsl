...
Процедура ОбновитьПредставление() Экспорт
	...
	Если ЗначениеЗаполнено(ТипОбъектаДокументооборота) Тогда 
		...
		Если ТипОбъектаДокументооборота = "DMIncomingDocument" Тогда
			ПредставлениеОбъектаДокументооборота = НСтр("ru='Входящий документ';uk='Вхідний документ'");
		ИначеЕсли ТипОбъектаДокументооборота = "DMInternalDocument" Тогда
			ПредставлениеОбъектаДокументооборота = НСтр("ru='Внутренний документ';uk='Внутрішній документ'");
		ИначеЕсли ТипОбъектаДокументооборота = "DMOutgoingDocument" Тогда
			ПредставлениеОбъектаДокументооборота = НСтр("ru='Исходящий документ';uk='Вихідний документ'");
		ИначеЕсли ТипОбъектаДокументооборота = "DMCorrespondent" Тогда
			ПредставлениеОбъектаДокументооборота = НСтр("ru='Корреспондент';uk='Кореспондент'");
		Иначе

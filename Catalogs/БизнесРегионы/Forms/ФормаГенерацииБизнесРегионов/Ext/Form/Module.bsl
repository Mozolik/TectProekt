...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		СообщениеПользователю = НСтр("ru='Для заполнения списка регионов необходимо выбрать карту в разделе администрирования ""Маркетинг и CRM"".';uk='Для заповнення списку регіонів необхідно вибрати карту в розділі адміністрування ""Маркетінг і CRM"".'");
...
Процедура Заполнить(Команда)
	...
	Иначе
		СообщениеПользователю = НСтр("ru='Необходимо выбрать хотя бы один географический регион для заполнения бизнес-регионов.';uk='Необхідно вибрати хоча б один географічний регіон для заповнення бізнес-регіонів.'");
...
Функция ЗаполнитьБизнесРегионы()
	...
	ДеревоРегионов = ДанныеФормыВЗначение(ГеографическиеРегионы, Тип("ДеревоЗначений"));

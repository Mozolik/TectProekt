...
Процедура ПередЗаписью(Отказ)
	...
	Если Задание = Неопределено Тогда
		...
		ПараметрыЗадания.Вставить("Наименование", СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Автоматическое начисление и списание бонусных баллов: %1';uk='Автоматичне нарахування і списання бонусних балів: %1'"), 
...
Процедура ПриЗаписи(Отказ)
	...
	НаименованиеЗадания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Автоматическое начисление и списание бонусных баллов: %1';uk='Автоматичне нарахування і списання бонусних балів: %1'"), СокрЛП(Объект.Наименование));

...
Функция ТекстПоясненияДоступныеСпособыОтправки()
	...
	Если ПредназначенаДляЭлектронныхПисем И ПредназначенаДляSMS Тогда
		ТекстПояснения = НСтр("ru='Будут отправляться Email и SMS';uk='Будуть відправлятися Email і SMS'");
	ИначеЕсли ПредназначенаДляЭлектронныхПисем Тогда
		ТекстПояснения = НСтр("ru='Будут отправляться Email';uk='Будуть відправлятися Email'");
	Иначе
		ТекстПояснения = НСтр("ru='Будут отправляться SMS';uk='Будуть відправлятися SMS'");
	КонецЕсли;

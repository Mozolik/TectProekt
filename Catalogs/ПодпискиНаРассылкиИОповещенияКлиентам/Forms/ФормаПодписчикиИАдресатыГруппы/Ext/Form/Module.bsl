...
Процедура Приостановить(Команда)
	...
	Если КоличествоОтменяемыхПодписок > 0 Тогда
		...
		ТекстПояснения = НСтр("ru='Подписка отменена для %1 партнеров.';uk='Підписка скасована для %1 партнерів.'");
			...
			Если ВыборкаАдресат.АдресатПодписки <> ВыборкаАдресат.Подписчик Тогда
				...
				Если ПредназначенаДляЭлектронныхПисем Тогда
					...
					Если ПустаяСтрока(Email) Тогда
							...
							Email = НСтр("ru='не указаны';uk='не зазначені'");
						Иначе
				...
				Если ПредназначенаДляSMS Тогда
					...
					Если ПустаяСтрока(Телефон) Тогда
						...
						Телефон = НСтр("ru='не указаны';uk='не зазначені'");
					Иначе
				...
				Если ПредназначенаДляЭлектронныхПисем Тогда
					...
					Если ПустаяСтрока(Email) Тогда
						...
						Иначе
							...
							Email = НСтр("ru='<не требуется>';uk='<не потрібно>'");
						КонецЕсли;
					Иначе
					...
					Иначе
						...
						ВидыКИ = НСтр("ru='<не требуется>';uk='<не потрібно>'");
					КонецЕсли;
				...
				Если ПредназначенаДляSMS Тогда
					...
					Если ПустаяСтрока(Телефон) Тогда
						...
						Иначе
							...
							Телефон = НСтр("ru='<не требуется>';uk='<не потрібно>'");
						КонецЕсли;
					Иначе

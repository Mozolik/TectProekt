...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ШаблонОшибка = НСтр("ru='Время окончания действия скидки (наценки )меньше времени начала в строке %НомерСтроки%';uk='Час закінчення дії знижки (націнки )менше часу початку в рядку %НомерСтроки%'");

...
Процедура ПеренестиВДокумент(Команда)
	...
	Если УсловияПредоставления.Количество() = 0 Тогда
		ПоказатьВопрос(Новый ОписаниеОповещения("ПеренестиВДокументЗавершение", ЭтотОбъект), НСтр("ru='Не подобрано ни одного условия. Закрыть?';uk='Не підібрано жодної умови. Закрити?'"), РежимДиалогаВопрос.ДаНет);
        Возврат;
	КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Владелец <> Справочники.НаборыУпаковок.БазовыеЕдиницыИзмерения Тогда
		ТекстИсключения = НСтр("ru='Форма предназначена для отображения только списка единиц упаковок.';uk='Форма призначена для відображення тільки списку одиниць упаковок.'");

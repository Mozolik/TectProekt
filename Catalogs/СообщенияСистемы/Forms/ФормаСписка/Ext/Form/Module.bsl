...
Процедура ОтправитьИПолучитьСообщения(Команда)
	...
	Если ЭтоСеансСУстановленнымиЗначениямиРазделителей Тогда
		ТекстСообщения = НСтр("ru='Обработка сообщений возможна только в неразделенном сеансе администратора сервиса.';uk='Обробка повідомлень можлива тільки в нерозділеному сеансі адміністратора сервісу.'");
	...
	Если Элементы.Список.ТекущиеДанные <> Неопределено Тогда
		...
		Иначе
			...
			Если Элементы.Список.ВыделенныеСтроки.Количество() > 1 Тогда
				...
				СтрокаВопроса = НСтр("ru='Удалить выделенные сообщения?';uk='Видалити вибрані повідомлення?'");
				
			Иначе
				
				СтрокаВопроса = НСтр("ru='Удалить сообщение ""[Сообщение]""?';uk='Видалити повідомлення ""[Сообщение]""?'");

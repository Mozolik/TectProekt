...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтаФорма.ЛентаНовостей.Пустая() Тогда
		Элементы.Список.Подсказка = НСтр("ru='Категории без отбора, для всех лент новостей';uk='Категорії без відбору, для всіх стрічок новин'");
	...
	Иначе
		ТекстСообщения = НСтр("ru='Категории с отбором по ленте новостей %ЭтаФорма.ЛентаНовостей%';uk='Категорії з відбором по стрічці новин %ЭтаФорма.ЛентаНовостей%'");

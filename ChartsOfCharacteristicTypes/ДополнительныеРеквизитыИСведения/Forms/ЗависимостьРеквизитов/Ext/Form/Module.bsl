...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru='%1 дополнительного реквизита ""%2""';uk='%1 додаткового реквізиту ""%2""'");
	Если НастраиваемоеСвойство = "Доступен" Тогда
		ПредставлениеСвойства = НСтр("ru='Доступность';uk='Доступність'");
	ИначеЕсли НастраиваемоеСвойство = "ЗаполнятьОбязательно" Тогда
		ПредставлениеСвойства = НСтр("ru='Обязательность заполнения';uk='Обов''язковість заповнення'");
	Иначе
		ПредставлениеСвойства = НСтр("ru='Видимость';uk='Видимість'");
	КонецЕсли;

...
Функция ИнициализироватьДанныеДляНастройкиСоставаСтандартногоИнтерфейсаOData() Экспорт
	...
	ДобавитьКорневуюСтрокуДерева("Константа", НСтр("ru='Константы';uk='Константи'"), 1, БиблиотекаКартинок.Константа);
	ДобавитьКорневуюСтрокуДерева("Справочник", НСтр("ru='Справочники';uk='Довідники'"), 2, БиблиотекаКартинок.Справочник);
	ДобавитьКорневуюСтрокуДерева("Документ", НСтр("ru='Документы';uk='Документи'"), 3, БиблиотекаКартинок.Документ);
	ДобавитьКорневуюСтрокуДерева("ЖурналДокументов", НСтр("ru='Журналы документов';uk='Журнали документів'"), 4, БиблиотекаКартинок.ЖурналДокументов);
	ДобавитьКорневуюСтрокуДерева("Перечисление", НСтр("ru='Перечисление';uk='Перелічення'"), 5, БиблиотекаКартинок.Перечисление);
	ДобавитьКорневуюСтрокуДерева("ПланВидовХарактеристик", НСтр("ru='Планы видов характеристик';uk='Плани видів характеристик'"), 6, БиблиотекаКартинок.ПланВидовХарактеристик);
	ДобавитьКорневуюСтрокуДерева("ПланСчетов", НСтр("ru='Планы счетов';uk='Плани рахунків'"), 7, БиблиотекаКартинок.ПланСчетов);
	ДобавитьКорневуюСтрокуДерева("ПланВидовРасчета", НСтр("ru='Планы видов расчета';uk='Плани видів розрахунку'"), 8, БиблиотекаКартинок.ПланВидовРасчета);
	ДобавитьКорневуюСтрокуДерева("РегистрСведений", НСтр("ru='Регистры сведений';uk='Регістри відомостей'"), 9, БиблиотекаКартинок.РегистрСведений);
	ДобавитьКорневуюСтрокуДерева("РегистрНакопления", НСтр("ru='Регистры накопления';uk='Регістри накопичення'"), 10, БиблиотекаКартинок.РегистрНакопления);
	ДобавитьКорневуюСтрокуДерева("РегистрБухгалтерии", НСтр("ru='Регистры бухгалтерии';uk='Регістри бухгалтерії'"), 11, БиблиотекаКартинок.РегистрБухгалтерии);
	ДобавитьКорневуюСтрокуДерева("РегистрРасчета", НСтр("ru='Регистры расчета';uk='Регістри розрахунку'"), 12, БиблиотекаКартинок.РегистрРасчета);
	ДобавитьКорневуюСтрокуДерева("БизнесПроцесс", НСтр("ru='Бизнес-процессы';uk='Бізнес-процеси'"), 13, БиблиотекаКартинок.БизнесПроцесс);
	ДобавитьКорневуюСтрокуДерева("Задача", НСтр("ru='Задачи';uk='Задачі'"), 14, БиблиотекаКартинок.Задача);
	ДобавитьКорневуюСтрокуДерева("ПланОбмена", НСтр("ru='Планы обмена';uk='Плани обміну'"), 15, БиблиотекаКартинок.ПланОбмена);
	
	// Читаем текущий состав стандартного интерфейса OData
	СистемныйСостав = РаботаВБезопасномРежиме.ВычислитьВБезопасномРежиме("ПолучитьСоставСтандартногоИнтерфейсаOData()");
	...
	Для Каждого ЭлементМодели Из Модель Цикл
		...
		Если ОбщегоНазначенияБТС.ОбъектМетаданныхДоступенПоФункциональнымОпциям(ПолноеИмя) Тогда
...
Процедура ДобавитьВложеннуюСтрокуДерева(Знач ПолноеИмя, Знач ТолькоЧтение, Знач Использование, Знач Зависимости)
	...
	НоваяСтрока.Представление = ОбщегоНазначенияБТС.ПредставлениеОбъектаМетаданных(ПолноеИмя);
	...
	НоваяСтрока.Подчиненный = ОбщегоНазначенияБТС.ЭтоНаборЗаписей(ПолноеИмя) И
		Не ОбщегоНазначенияБТС.ЭтоНезависимыйНаборЗаписей(ПолноеИмя);
	...
	Для Каждого ОбъектЗависимость Из Зависимости Цикл
		...
		Если ОбщегоНазначенияБТС.ОбъектМетаданныхДоступенПоФункциональнымОпциям(ОбъектЗависимость) Тогда

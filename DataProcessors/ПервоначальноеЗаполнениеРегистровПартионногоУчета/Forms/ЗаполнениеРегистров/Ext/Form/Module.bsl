...
Функция ПолучитьДанныеНаСервере(Параметры)
	...
	Иначе	
		НаименованиеЗадания = НСтр("ru='Проведение по регистрам партий';uk='Проведення по регістрах партій'");
...
Процедура ЗагрузитьРезультат()
	...
	ИмяСобытия = НСтр("ru='Партионный учет сервер. Первоначальное заполнение данных документов по регистрам партий, НДС, сумм в валюте регл';uk='Партіонний облік сервер. Первинне заповнення даних документів у регістрах партій, ПДВ, сум в валюті регл'");
...
Процедура УстановитьИзмененияВИнтерфейсе()
	...
	Если Элементы.СтраницыФормы.ТекущаяСтраница = Элементы.ЗаполнениеРегистров Тогда
		Элементы.ФормаКнопкаДалее.Заголовок    = НСтр("ru='Начать проведение >>';uk='Почати проведення >>'");
	...
	Иначе
		...
		Элементы.ФормаКнопкаДалее.Заголовок    = НСтр("ru='Готово';uk='Готово'");

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ID) И ЗначениеЗаполнено(Тип) Тогда 
		...
		Заголовок = ОбъектXDTO.name + НСтр("ru=' (Корреспондент)';uk=' (Кореспондент)'");
	...
	Иначе
		...
		Заголовок = НСтр("ru='Корреспондент (создание)';uk='Кореспондент (створення)'");
	КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(ID)
		...
		Если ЮрФизЛицо = НСтр("ru='Физическое лицо';uk='Фізична особа'") Тогда
			ЮрФизЛицоID = "ФизЛицо";
			ЮрФизЛицоТип = "DMLegalPrivatePerson";
		ИначеЕсли ЮрФизЛицо = НСтр("ru='Юридическое лицо';uk='Юридична особа'") Тогда
			ЮрФизЛицоID = "ЮрЛицо";
			ЮрФизЛицоТип = "DMLegalPrivatePerson";
		ИначеЕсли ЮрФизЛицо = НСтр("ru='Индивидуальный предприниматель';uk='Індивідуальний підприємець'") Тогда
			ЮрФизЛицоID =  "ИндивидуальныйПредприниматель";
			ЮрФизЛицоТип = "DMLegalPrivatePerson";
		ИначеЕсли ЮрФизЛицо = НСтр("ru='Не резидент';uk='Не резидент'")   Тогда
...
Процедура СоздатьБизнесПроцесс(Команда)
	...
	Иначе
		...
		ТекстВопроса = НСтр("ru='Данные еще не записаны.
                            ...
                            |Створення бізнес-процесу можливе тільки після запису даних.
...
Функция НовыйСоответствиеСвойствXDTOИРеквизитовОбъекта()
	...
	СоответствиеРеквизитов.Вставить("КодПоЕДРПОУ", "okpo");
...
Процедура ОбновитьДекорацииСвязи()
	...
	Если Не ДокументЗаполнен Тогда
		...
		ИначеЕсли ПравилаЗаполнения.Количество() = 0 Тогда
			...
			Возврат;
		Иначе
			ТекстЗаголовкаВыбрать = НСтр("ru='создать...';uk='створити...'");
		КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДниНедели.Добавить(НСтр("ru='Понедельник';uk='Понеділок'"));
	ДниНедели.Добавить(НСтр("ru='Вторник';uk='Вівторок'"));
	ДниНедели.Добавить(НСтр("ru='Среда';uk='Середа'"));
	ДниНедели.Добавить(НСтр("ru='Четверг';uk='Четвер'"));
	ДниНедели.Добавить(НСтр("ru='Пятница';uk='П''ятниця'"));
	ДниНедели.Добавить(НСтр("ru='Суббота';uk='Субота'"));
	ДниНедели.Добавить(НСтр("ru='Воскресенье';uk='Неділя'"));
...
Процедура УстановитьПометкуУдаленияНаКлиенте()
	...
	Если Элементы.Список.ВыделенныеСтроки.Количество() = 1 Тогда
		ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			    НСтр("ru='Пометить ""%1"" на удаление?';uk='Відмітити ""%1"" для вилучення?'"), Элементы.Список.ТекущиеДанные.Ссылка);
	Иначе			

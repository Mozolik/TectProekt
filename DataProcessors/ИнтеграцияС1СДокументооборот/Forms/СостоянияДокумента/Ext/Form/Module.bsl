...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ДокументID) Тогда 
		...
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Состояние документа ""%1""';uk='Стан документа ""%1""'"),
			Документ);
		
	Иначе
		
		Если ДокументТип = "DMIncomingDocument" Тогда 
			СостояниеРегистрация = НСтр("ru='На регистрации';uk='На реєстрації'");
			СостояниеРегистрацияID = "НаРегистрации";
			СостояниеРегистрацияТип = "DMDocumentStatus";
		Иначе
			СостояниеРегистрация = НСтр("ru='Проект';uk='Проект'");
	...
	Если Параметры.ТолькоПросмотр Тогда 
		...
		Элементы.ФормаОтмена.Заголовок = НСтр("ru='Закрыть';uk='Закрити'");

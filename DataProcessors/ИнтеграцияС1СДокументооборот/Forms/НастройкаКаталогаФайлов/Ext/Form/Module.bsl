...
Процедура ПутьККаталогуНачалоВыбораПослеПодключенияРасширения(Подключено, ПараметрыОповещения) Экспорт
	...
	Если Подключено Тогда
		...
		ДиалогОткрытияФайла.Заголовок = НСтр("ru='Выберите путь к каталогу для временных файлов';uk='Виберіть шлях до каталогу для тимчасових файлів'");
	...
	Иначе // веб-клиент без расширение
		...
		ПоказатьПредупреждение(, НСтр("ru='Для выбора каталога в веб-клиенте необходимо установить расширение для работы с файлами.';uk='Для вибору каталогу у веб-клієнті необхідно встановити розширення для роботи з файлами.'"));

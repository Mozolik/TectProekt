...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипОбъектаВыбора = "DMIncomingDocument" 
		...
		ДобавитьРеквизитПоиска("documentType", НСтр("ru='Вид документа';uk='Вид документу'"), ТипОбъектаВыбора + "Type");
		ДобавитьРеквизитПоиска("summary", НСтр("ru='Содержание';uk='Зміст'"), "Строка");
		ДобавитьРеквизитПоиска("comment", НСтр("ru='Комментарий';uk='Коментар'"), "Строка");
		ДобавитьРеквизитПоиска("regNumber", НСтр("ru='Рег. номер';uk='Реєстр. номер'"), "Строка");
		ДобавитьРеквизитПоиска("regDate", НСтр("ru='Дата регистрации';uk='Дата реєстрації'"), "Дата");
		ДобавитьРеквизитПоиска("sum", НСтр("ru='Сумма';uk='Сума'"), "Число");
		ДобавитьРеквизитПоиска("currency", НСтр("ru='Валюта';uk='Валюта'"), "DMCurrency");
		ДобавитьРеквизитПоиска("organization", НСтр("ru='Организация';uk='Організація'"), "DMOrganization");
		ДобавитьРеквизитПоиска("subdivision", НСтр("ru='Подразделение';uk='Підрозділ'"), "DMSubdivision");
		ДобавитьРеквизитПоиска("accessLevel", НСтр("ru='Гриф доступа';uk='Гриф доступу'"), "DMAccessLevel");
		ДобавитьРеквизитПоиска("performanceDate", НСтр("ru='Срок исполнения';uk='Строк виконання'"), "Дата");
		ДобавитьРеквизитПоиска("activityMatter", НСтр("ru='Вопрос деятельности';uk='Питання діяльності'"), "DMActivityMatter");
		ДобавитьРеквизитПоиска("responsible", НСтр("ru='Ответственный';uk='Відповідальний'"), "DMUser");
		ДобавитьРеквизитПоиска("project", НСтр("ru='Проект';uk='Проект'"), "DMProject");
		Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("1.4.7.1") Тогда
			ДобавитьРеквизитПоиска("status", НСтр("ru='Состояние';uk='Стан'"), "DMDocumentStatus");
		КонецЕсли;
	КонецЕсли;
	
	Если ТипОбъектаВыбора = "DMIncomingDocument" Тогда
		ДобавитьРеквизитПоиска("externalNumber", НСтр("ru='Исходящий номер';uk='Вихідний номер'"), "Строка");
		ДобавитьРеквизитПоиска("externalDate", НСтр("ru='Исходящая дата';uk='Вихідна дата'"), "Дата");
		ДобавитьРеквизитПоиска("correspondent", НСтр("ru='Отправитель';uk='Відправник'"), "DMCorrespondent");
		ДобавитьРеквизитПоиска("signer", НСтр("ru='Подписал';uk='Підписав'"), "DMContactPerson");
		ДобавитьРеквизитПоиска("addressee", НСтр("ru='Адресат';uk='Адресат'"), "DMUser");
		ДобавитьРеквизитПоиска("deliveryMethod", НСтр("ru='Способ получения';uk='Спосіб отримання'"), "DMDeliveryMethod");
		
	ИначеЕсли ТипОбъектаВыбора = "DMInternalDocument" Тогда
		ДобавитьРеквизитПоиска("folder", НСтр("ru='Папка';uk='Папка'"), "DMInternalDocumentFolder");
		ДобавитьРеквизитПоиска("beginDate", НСтр("ru='Дата начала действия';uk='Дата початку дії'"), "Дата");
		ДобавитьРеквизитПоиска("endDate", НСтр("ru='Дата окончания действия';uk='Дата закінчення дії'"), "Дата");
		ДобавитьРеквизитПоиска("openEnded", НСтр("ru='Бессрочный';uk='Безстроковий'"), "Булево");
		ДобавитьРеквизитПоиска("correspondent", НСтр("ru='Корреспондент';uk='Кореспондент'"), "DMCorrespondent");
		ДобавитьРеквизитПоиска("contactPerson", НСтр("ru='Контактное лицо';uk='Контактна особа'"), "DMContactPerson");
		ДобавитьРеквизитПоиска("signer", НСтр("ru='Утвердил';uk='Затвердив'"), "DMUser");
		ДобавитьРеквизитПоиска("author", НСтр("ru='Подготовил';uk='Підготував'"), "DMUser");
		ДобавитьРеквизитПоиска("prolongationProcedure", НСтр("ru='Порядок продления';uk='Порядок продовження'"), "DMProlongationProcedure");
		
	ИначеЕсли ТипОбъектаВыбора = "DMOutgoingDocument" Тогда
		ДобавитьРеквизитПоиска("signer", НСтр("ru='Подписал';uk='Підписав'"), "DMUser");
		ДобавитьРеквизитПоиска("author", НСтр("ru='Подготовил';uk='Підготував'"), "DMUser");
		
	ИначеЕсли ТипОбъектаВыбора = "DMCorrespondent" Тогда
		ДобавитьРеквизитПоиска("inn", НСтр("ru='ИНН';uk='ІПН'"), "Строка");
		ДобавитьРеквизитПоиска("okpo", "Код по ЕДРПОУ", "Строка");
		ДобавитьРеквизитПоиска("fullName", НСтр("ru='Полное наименование';uk='Повне найменування'"), "Строка");
		ДобавитьРеквизитПоиска("comment", НСтр("ru='Комментарий';uk='Коментар'"), "Строка");
		ДобавитьРеквизитПоиска("privatePerson", НСтр("ru='Физическое лицо';uk='Фізична особа'"), "DMPrivatePerson");
		ДобавитьРеквизитПоиска("legalPrivatePerson", НСтр("ru='Юр./физ. лицо';uk='Юр./фіз. особа'"), "DMLegalPrivatePerson");
		ДобавитьРеквизитПоиска("responsible", НСтр("ru='Ответственный';uk='Відповідальний'"), "DMUser");
	...
	Если ЗначениеЗаполнено(Оператор) Тогда
		Если Тип = "Строка" Тогда
			Если Оператор = "=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='равно ""%1""';uk='дорівнює ""%1""'"), Значение);
			ИначеЕсли Оператор = "LIKE" Тогда
				Если Лев(Значение, 1) = "%"	и Прав(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='содержит ""%1""';uk='містить ""%1""'"), Сред(Значение, 2, СтрДлина(Значение) - 2));
				ИначеЕсли Лев(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='заканчивается на ""%1""';uk='закінчується на ""%1""'"), Сред(Значение,2));
				ИначеЕсли Прав(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='начинается с ""%1""';uk='починається з ""%1""'"), Лев(Значение, СтрДлина(Значение) - 1));
				КонецЕсли;
			КонецЕсли;
		ИначеЕсли Тип = "Число" Тогда
			...
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='между %1 и %2';uk='між %1 і %2'"), Значение, Значение2);
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='по %1';uk='по %1'"), Значение);
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='от %1';uk='від %1'"), Значение);
			КонецЕсли;
		ИначеЕсли Тип = "Дата" Тогда
			Если Оператор = "=" Тогда
				...
				Иначе
					Представление = "(" + НСтр("ru='пустая';uk='порожня'") + ")";
				КонецЕсли;
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='между %1 и %2';uk='між %1 і %2'"), Формат(Значение, "ДЛФ=D"), Формат(Значение2, "ДЛФ=D"));
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='по %1';uk='по %1'"), Формат(Значение, "ДЛФ=D"));
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='с %1';uk='з %1'"), Формат(Значение, "ДЛФ=D"));
			КонецЕсли;

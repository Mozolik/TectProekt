...
Функция СформироватьТабличныйДокументСервер()
	...
	РезультатФоновогоЗадания = ДлительныеОперации.ЗапуститьВыполнениеВФоне(УникальныйИдентификатор,
		...
		ПараметрыЗадания, НСтр("ru='Формирование отчета по составу данных для отправки при синхронизации';uk='Формування звіту по складу даних для відправлення при синхронізації'"));

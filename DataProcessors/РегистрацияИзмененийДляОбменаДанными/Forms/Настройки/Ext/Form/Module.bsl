...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТекущийОбъект.ЭтоФайловаяБаза() Тогда
		...
		Если ТекЭлемент <> Неопределено Тогда
			ТекЭлемент.Представление = НСтр("ru='В каталоге:';uk='В каталозі:'");
		КонецЕсли;
	КонецЕсли;
...
#Иначе
	ВызватьИсключение(НСтр("ru='В WEB-клиенте данная возможность недоступна.';uk='У WEB-клієнті ця можливість недоступна.'"));
#КонецЕсли
...
Процедура ПослеПроверкиРасширенияРаботыСФайлами(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат Тогда
		...
		Диалог.Фильтр = НСтр("ru='Внешние обработки (*.epf)|*.epf';uk='Зовнішні обробки (*.epf)|*.epf'");

...
#КонецЕсли
		...
		ВызватьИсключение(НСтр("ru='Менеджер сервиса не поддерживает резервное копирование приложений';uk='Менеджер сервісу не підтримує резервне копіювання додатків'"));

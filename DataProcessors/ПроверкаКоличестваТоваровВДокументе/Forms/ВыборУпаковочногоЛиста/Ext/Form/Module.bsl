...
Процедура ОК(Команда)
	...
	Если Не ЗначениеЗаполнено(УпаковочныйЛист) Тогда
		Если Не ЗначениеЗаполнено(Код) Тогда
			...
			ТекстВопроса = НСтр("ru='Упаковочный лист не выбран. Очистить упаковочный лист в выделенных строках?';uk='Пакувальний лист не вибрано. Очистити пакувальний лист у виділених рядках?'");
		...
		Иначе
			СтрокаСообщения = НСтр("ru='Упаковочный лист с кодом %1% не найден.';uk='Пакувальний лист з кодом %1% не знайдено.'");
...
Процедура ПечатьЭтикетки(Команда)
	...
	Если Не ЗначениеЗаполнено(УпаковочныйЛист) Тогда
		ТекстСообщения = НСтр("ru='Для печати этикетки введите код существующего упаковочного листа или создайте новый.';uk='Для друку етикетки введіть код існуючого пакувального листа або створіть новий.'");

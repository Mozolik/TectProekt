...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Элементы.ДополнительныеТерритории.Видимость = Ложь И Элементы.УлицыИНаселенныеПункты.Видимость = Ложь Тогда
		КраткоеПредставлениеОшибки = НСтр("ru='Данные о улицах, населенных пунктах и дополнительных территориях для введенного адреса отсутствуют';uk='Дані про вулицях, населених пунктах і додаткових територіях для введеної адреси відсутні'");
		Возврат;
	КонецЕсли;

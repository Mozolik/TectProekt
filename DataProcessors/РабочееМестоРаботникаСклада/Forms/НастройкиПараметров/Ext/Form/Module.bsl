...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьПодключаемоеОборудование") Тогда
		ТекстИсключения = НСтр("ru='В настройках программы отключено использование подключаемого оборудования. Использовать мобильные рабочие места работников склада можно только при использовании подключаемого оборудования.';uk='У настройках програми відключено використання обладнання для підключення. Використовувати мобільні робочі місця працівників складу можна тільки при використанні обладнання для підключення.'");
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	ШаблонОшибкиРеквизитаТЧ = НСтр("ru='Не заполнена колонка ""Рабочий участок"" в строке %НомерСтроки% списка ""Рабочие участки""';uk='Не заповнена колонка ""Робоча ділянка"" в рядку %НомерСтроки% списку ""Робочі ділянки""'");

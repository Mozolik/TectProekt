...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Если Выборка.ОшибкаЗаполнения = Перечисления.ТипыОбеспечения.Перемещение Тогда
			ТекстСообщения = НСтр("ru='Потребности в работах не обеспечиваются перемещением';uk='Потреби в роботах не забезпечуються переміщенням'");
		Иначе
			ТекстСообщения = НСтр("ru='Потребности в работах не обеспечиваются сборкой/разборкой';uk='Потреби в роботах не забезпечуються збиранням/розбиранням'");
		КонецЕсли;

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заколовок = НСтр("ru='Характеристики номенклатуры: %1';uk='Характеристики номенклатури: %1'");
...
Процедура Сохранить(Команда)
	...
	Если ТаблицаХарактеристик.НайтиСтроки(Новый Структура("Выбрана", Истина)).Количество()= 0 Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Выберите хотя бы одну характеристику.';uk='Виберіть хоча б одну характеристику.'"),
			,

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьФорматыМагазинов") Тогда
		...
		ЭтаФорма.Заголовок = НСтр("ru='История изменения настроек ассортимента магазинов';uk='Історія зміни настройок асортименту магазинів'");
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(СтрокаСписка.Период) Тогда
		...
		ЗначенияЗаполнения.Вставить("Период", Макс(ТекущаяДата(), ДатаНачала, ДатаОкончания));
...
Процедура ОчиститьФормат(Команда)
	...
	Период = Макс(СтрокаСписка.Период, НачалоДня(ТекущаяДата()), ДатаНачала, ДатаОкончания);

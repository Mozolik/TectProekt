...
Процедура ИспользоватьРекомендуемоеНормативноеКоличествоЗапаса(Команда)
	...
	Если МассивЗаписей.Количество() = 0 Тогда
		ТекстСообщения = НСтр("ru='Выделите строки, в которых нужно установить использование рекомендуемого нормативного запаса.';uk='Виділіть рядки, в яких потрібно встановити використання рекомендованого нормативного запасу.'");
		ПоказатьПредупреждение(Неопределено, ТекстСообщения);
		Возврат;
	Иначе
		ТекстВопроса = НСтр("ru='При выполнении операции в выделенных строках будет очищено нормативное количество запаса, назначенное вручную. Продолжить?';uk='При виконанні операції у виділених рядках буде очищено нормативну кількість запасу, призначену вручну. Продовжити?'");
		Ответ = Неопределено;
...
Процедура УстановитьОтборы()
	...
	ИначеЕсли ЗначениеЗаполнено(Склад)
		...
		ТекстЗаголовка = НСтр("ru='На складе ""%Склад%"" не используется подпитка зон быстрого отбора, поэтому прогнозирование расхода упаковок не ведется.';uk='На складі ""%Склад%"" не використовується підживлення зон швидкого відбору, тому прогнозування витрат упаковок не ведеться.'");

...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ТекстСообщенияХарактеристика = НСтр("ru='Поле ""Характеристика"" не заполнено';uk='Поле ""Характеристика"" не заповнено'");
	ТекстСообщенияСерия          = НСтр("ru='Поле ""Серия"" не заполнено';uk='Поле ""Серія"" не заповнено'");
	ТекстСообщенияПомещение      = НСтр("ru='Поле ""Помещение"" не заполнено';uk='Поле ""Приміщення"" не заповнено'");

...
Функция ПереместитьДанныеВНовыйРегистр() Экспорт
	...
	Если Выборка.Количество() < 10000 Тогда
		...
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ru='Завершен перенос данных из регистра УдалитьНаборыЗначенийДоступа.';uk='Завершене перенесення даних з регістра УдалитьНаборыЗначенийДоступа.'"),
	...
	Иначе
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ru='Выполнен шаг переноса данных из регистра УдалитьНаборыЗначенийДоступа.';uk='Виконаний крок перенесення даних з регістра УдалитьНаборыЗначенийДоступа.'"),
			РежимТранзакцииЗаписиЖурналаРегистрации.Транзакционная);
	КонецЕсли;

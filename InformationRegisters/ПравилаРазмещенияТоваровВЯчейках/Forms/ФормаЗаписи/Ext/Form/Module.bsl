...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ТипНоменклатуры = Перечисления.ТипыНоменклатуры.Товар
		...
		И Не ЗначениеЗаполнено(Запись.СкладскаяГруппаУпаковок) Тогда
		ТекстСообщения = НСтр("ru='Поле ""Складская группа упаковок"" не заполнено';uk='Поле ""Складська група упаковок"" не заповнено'");
...
Процедура УстановитьДоступность()
	...
	Элементы.Размещение.Доступность = (ТипНоменклатуры = Перечисления.ТипыНоменклатуры.Товар)
		...
		И ПравоДоступа("Изменение", Метаданные.РегистрыСведений.ПравилаРазмещенияТоваровВЯчейках.Измерения.СкладскаяГруппаУпаковок);
КонецПроцедуры

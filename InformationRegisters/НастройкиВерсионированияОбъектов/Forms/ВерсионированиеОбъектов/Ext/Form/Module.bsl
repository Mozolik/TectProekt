...
Функция ТекстСостоянияПодсчет()
	Возврат НСтр("ru='Поиск устаревших версий...';uk='Пошук застарілих версій...'");
КонецФункции

&НаКлиентеНаСервереБезКонтекста
Функция ТекстСостоянияОчистка()
	Возврат НСтр("ru='Выполняется очистка устаревших версий...';uk='Виконується очищення застарілих версій...'");
КонецФункции

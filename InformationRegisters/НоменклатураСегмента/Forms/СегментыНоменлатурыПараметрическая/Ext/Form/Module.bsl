...
Процедура СегментыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "СегментыКоличествоХарактеристик" Тогда
		...
		Если ТекущиеДанные.Характеристики.Количество() = 0 Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Характеристики не назначены.';uk='Характеристики не призначені.'"));
			Возврат;
		КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<Отсутствуют>';uk='<Відсутні>'"));
...
Процедура ВключитьУдалитьВСегментКлиент(Включить)
	...
	Если ИспользуютсяХарактеристики Тогда
		...
		Если Элементы.Сегменты.ДанныеСтроки(ВыделенныеСтроки[0]).Характеристики.Количество() = 0 Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru='Для данной номенклатуры предусмотрен учет по характеристикам, но не указано ни одной характеристики. Включение в сегмент невозможно.';uk='Для даної номенклатури передбачений облік за характеристиками, але не вказано жодної характеристики. Включення до сегменту неможливо.'"));
			Возврат;
		КонецЕсли;

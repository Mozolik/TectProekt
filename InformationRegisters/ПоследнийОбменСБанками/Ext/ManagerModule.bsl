...
Процедура СоздатьЗапись(БанковскийСчет, ПараметрыЗаписи) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru='Запись в регистр сведений ""Последний обмен с банками""';uk='Запис в регістр відомостей ""Останній обмін з банками""'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),

...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьОбобщенныйУчетНекачественныхТоваров") Тогда
		...
		Если Выборка.Следующий() Тогда
			ТекстСообщения = НСтр("ru='Нельзя связывать номенклатуру ""%НоменклатураБрак%"" более чем с одной номенклатурой исходного качества.';uk='Не можна пов''язувати номенклатуру ""%НоменклатураБрак%"" більш ніж з однією номенклатурою вихідної якості.'");	

...
Процедура ПередЗаписью(Отказ)
	...
	Если УзелУжеСуществует Тогда
		ТекстСообщения = НСтр("ru='Настройка для торгового представителя %Пользователь% и мобильного компьютера %МобильныйКомпьютер% уже существует';uk='Настройка для торгового представника %Пользователь% та мобільного комп''ютера %МобильныйКомпьютер% вже існує'");
